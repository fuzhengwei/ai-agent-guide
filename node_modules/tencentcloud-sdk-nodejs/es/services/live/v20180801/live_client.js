...
export class Client extends AbstractClient {
    ...
    async DeleteLiveAvatarCloneFigure(req, cb) {
    ...
    async DescribeAuditKeywordLibs(req, cb) {
        return this.request("DescribeAuditKeywordLibs", req, cb);
    }
    ...
    async ModifyAuditKeywordLib(req, cb) {
        return this.request("ModifyAuditKeywordLib", req, cb);
    }
    ...
    async DeleteAuditImages(req, cb) {
        return this.request("DeleteAuditImages", req, cb);
    }
    ...
    async CreateLiveAvatarCloneFigure(req, cb) {
    ...
    async DescribeAuditGroupTag(req, cb) {
        return this.request("DescribeAuditGroupTag", req, cb);
    }
    ...
    async CreateAuditImages(req, cb) {
        return this.request("CreateAuditImages", req, cb);
    }
    ...
    async DeleteAuditKeywordLib(req, cb) {
        return this.request("DeleteAuditKeywordLib", req, cb);
    }
    ...
    async DescribeAuditImages(req, cb) {
        return this.request("DescribeAuditImages", req, cb);
    }
    ...
    async DescribeLiveAvatarCloneFigureList(req, cb) {
