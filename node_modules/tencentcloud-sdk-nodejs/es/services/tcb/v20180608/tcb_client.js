...
export class Client extends AbstractClient {
    ...
    async DescribePlatformEnvUsage(req, cb) {
    ...
    async PurgeHTTPServiceCache(req, cb) {
    ...
    async CreatePlatformEnv(req, cb) {
    ...
    async DescribePlatformCreditsUsageDetail(req, cb) {
    ...
    async DescribePlatformAccountCircle(req, cb) {
    ...
    async DescribePlatformCreditsUsage(req, cb) {
    ...
    async ModifyPlatformEnv(req, cb) {
    ...
    async DestroyPlatformEnv(req, cb) {
