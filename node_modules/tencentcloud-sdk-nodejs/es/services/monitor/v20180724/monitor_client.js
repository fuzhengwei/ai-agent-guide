...
export class Client extends AbstractClient {
    ...
    async CreateAlarmHistoryShield(req, cb) {
    ...
    async DescribeGrafanaVersions(req, cb) {
    ...
    async DescribeAlarmHistoryShield(req, cb) {
        return this.request("DescribeAlarmHistoryShield", req, cb);
    }
    async ModifyPrometheusInstanceAccessPoints(req, cb) {
    ...
    async ModifyAlarmHistoryShield(req, cb) {
    ...
    async DeleteAlarmHistoryShields(req, cb) {
