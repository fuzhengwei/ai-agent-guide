...
export class Client extends AbstractClient {
    ...
    async DescribeDBProxySSLConfig(req, cb) {
        return this.request("DescribeDBProxySSLConfig", req, cb);
    }
    async DescribePostgRESTService(req, cb) {
    ...
    async CloseDBProxyAddress(req, cb) {
    ...
    async OpenPostgRESTService(req, cb) {
    ...
    async DescribeMem0Service(req, cb) {
    ...
    async ClosePostgRESTService(req, cb) {
    ...
    async CreateDBProxyAddress(req, cb) {
    ...
    async ModifyDBProxySSLConfig(req, cb) {
