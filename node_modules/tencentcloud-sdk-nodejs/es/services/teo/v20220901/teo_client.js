...
export class Client extends AbstractClient {
    ...
    async ModifyZoneCustomVariables(req, cb) {
    ...
    async DescribeAvailableOriginACLFamily(req, cb) {
    ...
    async DescribeAvailableCustomActionsForRuleEngine(req, cb) {
    ...
    async DescribeZoneCustomVariables(req, cb) {
