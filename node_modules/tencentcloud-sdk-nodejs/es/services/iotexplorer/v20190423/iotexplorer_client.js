...
export class Client extends AbstractClient {
    ...
    async DeleteTWeSeePerson(req, cb) {
    ...
    async DescribeTWeSeeDirectUploadInfo(req, cb) {
    ...
    async ListTWeSeePersons(req, cb) {
    ...
    async DescribeTWeSeePerson(req, cb) {
    ...
    async ModifyTWeSeePerson(req, cb) {
    ...
    async GetVodCloudStorageVideoList(req, cb) {
    ...
    async DescribeVodCloudStorageDate(req, cb) {
    ...
    async OperateTWeSeeDirectUploadObject(req, cb) {
    ...
    async DescribeCloudStorageEventsByTWeSeePerson(req, cb) {
    ...
    async GetVodCloudStorageEventList(req, cb) {
    ...
    async CreateTWeSeePerson(req, cb) {
    ...
    async BatchDescribeTWeSeeOrders(req, cb) {
    ...
    async DeleteTWeSeeTasksByCondition(req, cb) {
    ...
    async DescribeTWeSeeFace(req, cb) {
    ...
    async ImportTWeSeeFaces(req, cb) {
