...
export class Client extends AbstractClient {
    ...
    async DeleteConsumerLabels(req, cb) {
    ...
    async DescribeConsumerLabelRoutes(req, cb) {
    ...
    async DescribeConsumerLabelLists(req, cb) {
    ...
    async DeleteConsumerRouteConfigs(req, cb) {
    ...
    async DescribeConsumerRouteConfigs(req, cb) {
    ...
    async PutConsumerRouteConfigs(req, cb) {
    ...
    async CreateConsumerLabels(req, cb) {
