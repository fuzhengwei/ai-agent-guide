...
import { SetAutoRenewFlagRequest, DeleteBackupPlanResponse, DescribeAccountPrivilegesResponse, DescribeDatabasesRequest, DescribeDBXlogsRequest, DescribeAuditLogsRequest, ModifyDBProxySSLConfigRequest, DescribeMaintainTimeWindowRequest, DescribeAccountsRequest, DeleteReadOnlyGroupResponse, OpenDBExtranetAccessRequest, CreateInstancesRequest, ModifyDBInstanceSSLConfigRequest, DescribeDBProxySSLConfigResponse, CreateDBInstanceNetworkAccessResponse, DescribeAvailableRecoveryTimeResponse, CreateBaseBackupRequest, ModifyDBInstanceReadOnlyGroupResponse, SwitchDBInstancePrimaryRequest, DescribeCloneDBInstanceSpecRequest, DescribeDBInstanceSecurityGroupsResponse, RestoreDBInstanceObjectsResponse, ModifyDBInstanceDeletionProtectionRequest, CreateDBProxyAddressResponse, DeleteLogBackupResponse, ModifyReadOnlyGroupConfigRequest, ClosePostgRESTServiceResponse, DescribeProductConfigRequest, RemoveDBInstanceFromReadOnlyGroupRequest, CreateAccountRequest, DescribeDBProxySSLConfigRequest, DescribeMaintainTimeWindowResponse, DescribeDedicatedClustersResponse, RenewInstanceRequest, DescribeBackupOverviewRequest, DescribeMem0ServiceRequest, DescribeAuditInstanceListResponse, UpgradeDBInstanceMajorVersionResponse, ModifyBackupDownloadRestrictionRequest, ModifyDBInstanceDeploymentRequest, DeleteReadOnlyGroupNetworkAccessRequest, DescribeBackupPlansRequest, OpenDBExtranetAccessResponse, CreateDatabaseRequest, DescribeBackupSummariesRequest, CreateBackupPlanRequest, ModifyDBInstancesProjectResponse, CloseDBProxyAddressRequest, CreateBaseBackupResponse, LockAccountResponse, CloneDBInstanceResponse, ClosePostgRESTServiceRequest, AddDBInstanceToReadOnlyGroupResponse, CreateReadOnlyDBInstanceResponse, DescribeAvailableRecoveryTimeRequest, CloseAccountCAMRequest, DescribeDBProxySpecsResponse, DescribePostgRESTServiceRequest, CreateDBProxyAddressRequest, DescribeDBInstanceParametersRequest, DescribeOrdersResponse, DescribeBackupDownloadURLResponse, ModifyBaseBackupExpireTimeResponse, ModifyMaintainTimeWindowResponse, CloseMem0ServiceResponse, InquiryPriceCreateDBInstancesResponse, DeleteAuditLogFileResponse, ResetAccountPasswordRequest, CreateDBInstanceNetworkAccessRequest, ModifySwitchTimePeriodResponse, InquiryPriceCreateDBInstancesRequest, DescribeDefaultParametersResponse, DescribeBackupPlansResponse, CloseDBProxyAddressResponse, ModifyDBInstanceSpecRequest, ModifyAccountRemarkResponse, RefreshAccountPasswordRequest, OpenAccountCAMResponse, DescribeZonesRequest, ModifyMaintainTimeWindowRequest, ModifyBackupDownloadRestrictionResponse, DescribeLogBackupsRequest, ModifyDBInstanceParametersRequest, CreateAuditLogFileResponse, OpenMem0ServiceResponse, DeleteDatabaseResponse, DestroyDBProxyRequest, DescribeDBInstanceAttributeRequest, ResetAccountPasswordResponse, RemoveDBInstanceFromReadOnlyGroupResponse, ModifyDBProxyAddressRequest, DescribeDatabaseObjectsRequest, DescribeParameterTemplatesResponse, UpgradeDBInstanceKernelVersionRequest, OpenAuditServiceRequest, DestroyDBProxyResponse, SwitchDBInstancePrimaryResponse, ModifyReadOnlyDBInstanceWeightResponse, ModifyDBInstanceHAConfigRequest, DescribeAuditLogFilesResponse, DescribeTasksRequest, DeleteReadOnlyGroupNetworkAccessResponse, OpenPostgRESTServiceResponse, DescribeBackupSummariesResponse, DescribeDBErrlogsRequest, UnlockAccountResponse, DeleteBackupPlanRequest, CloneDBInstanceRequest, DeleteParameterTemplateRequest, DescribeClassesRequest, ModifyDBInstanceReadOnlyGroupRequest, DescribeParamsEventRequest, CreateInstancesResponse, ModifyDBProxyResponse, DescribeDBBackupsResponse, DescribeRegionsRequest, DescribeSlowQueryListResponse, CreateReadOnlyGroupRequest, ModifyDBInstanceSSLConfigResponse, DescribeParamsEventResponse, CloseAuditServiceResponse, ModifyDBProxyRequest, ModifyDBInstanceSecurityGroupsRequest, CloseAuditServiceRequest, DescribeDedicatedClustersRequest, CreateReadOnlyGroupNetworkAccessRequest, RestartDBInstanceRequest, DescribeDBInstanceHAConfigRequest, CreateParameterTemplateResponse, DescribeLogBackupsResponse, IsolateDBInstancesResponse, CreateDBProxyResponse, InquiryPriceUpgradeDBInstanceRequest, DescribeDBInstanceHAConfigResponse, DescribeDatabaseObjectsResponse, IsolateDBInstancesRequest, ModifyDBInstanceNameRequest, DescribeDBInstanceSSLConfigResponse, CloseAccountCAMResponse, ReloadBalanceDBProxyNodeResponse, InquiryPriceRenewDBInstanceResponse, DescribeSlowQueryAnalysisRequest, DescribeParameterTemplatesRequest, DestroyDBInstanceRequest, InquiryPriceRenewDBInstanceRequest, RenewInstanceResponse, DescribeBackupOverviewResponse, DescribeDBInstanceParametersResponse, OpenAccountCAMRequest, DescribeClassesResponse, DeleteDBInstanceNetworkAccessRequest, ModifyDBInstanceDeploymentResponse, UnlockAccountRequest, DeleteParameterTemplateResponse, ModifyReadOnlyDBInstanceWeightRequest, DescribeAuditInstanceListRequest, ModifyAccountPrivilegesResponse, DeleteDatabaseRequest, DeleteReadOnlyGroupRequest, DescribeDBBackupsRequest, SetAutoRenewFlagResponse, RestartDBInstanceResponse, DescribeReadOnlyGroupsRequest, DescribeBackupDownloadURLRequest, ModifyParameterTemplateRequest, DescribePostgRESTServiceResponse, DescribeDBVersionsResponse, ModifyAuditServiceRequest, ModifyDBInstanceSecurityGroupsResponse, CloseMem0ServiceRequest, ModifyDBInstanceNameResponse, UpgradeDBInstanceMajorVersionRequest, CloseDBExtranetAccessResponse, DescribeBackupDownloadRestrictionResponse, CreateReadOnlyDBInstanceRequest, DescribeCloneDBInstanceSpecResponse, DescribeZonesResponse, ReloadBalanceDBProxyNodeRequest, DescribeDatabasesResponse, DescribeProductConfigResponse, DescribeOrdersRequest, OpenAuditServiceResponse, CloseDBExtranetAccessRequest, ModifyParameterTemplateResponse, DescribeDBProxyRequest, DescribeEncryptionKeysRequest, RebalanceReadOnlyGroupRequest, ModifyBackupPlanResponse, DeleteAccountRequest, CreateReadOnlyGroupResponse, DeleteDBInstanceNetworkAccessResponse, ModifyAccountPrivilegesRequest, ModifyDBInstanceParametersResponse, ModifyReadOnlyGroupConfigResponse, ModifyDBProxySSLConfigResponse, ModifyAccountRemarkRequest, DescribeParameterTemplateAttributesRequest, DescribeDBErrlogsResponse, AddDBInstanceToReadOnlyGroupRequest, ModifyBackupPlanRequest, DeleteBaseBackupRequest, ModifyDBProxyAddressResponse, OpenPostgRESTServiceRequest, InquiryPriceUpgradeDBInstanceResponse, DisIsolateDBInstancesResponse, ModifyDatabaseOwnerResponse, CreateParameterTemplateRequest, DescribeDBInstanceSSLConfigRequest, CreateAuditLogFileRequest, DeleteAuditLogFileRequest, OpenMem0ServiceRequest, ModifySwitchTimePeriodRequest, CreateAccountResponse, DescribeSlowQueryListRequest, CreateDBProxyRequest, ModifyDatabaseOwnerRequest, DisIsolateDBInstancesRequest, CreateBackupPlanResponse, LockAccountRequest, DescribeDBInstancesResponse, DescribeDBInstanceSecurityGroupsRequest, DescribeBackupDownloadRestrictionRequest, ModifyBaseBackupExpireTimeRequest, ModifyDBInstanceHAConfigResponse, CreateDatabaseResponse, RebalanceReadOnlyGroupResponse, DescribeMem0ServiceResponse, DescribeTasksResponse, DescribeSlowQueryAnalysisResponse, ModifyDBInstanceDeletionProtectionResponse, DescribeDefaultParametersRequest, DescribeDBProxyResponse, DescribeAccountPrivilegesRequest, DescribeReadOnlyGroupsResponse, RestoreDBInstanceObjectsRequest, DescribeAccountsResponse, ModifyDBInstanceChargeTypeRequest, DescribeDBInstancesRequest, DescribeParameterTemplateAttributesResponse, UpgradeDBInstanceKernelVersionResponse, DescribeDBVersionsRequest, ModifyDBInstancesProjectRequest, ModifyAuditServiceResponse, DestroyDBInstanceResponse, DescribeDBInstanceAttributeResponse, DescribeDBProxySpecsRequest, DeleteLogBackupRequest, DeleteBaseBackupResponse, DescribeAuditLogFilesRequest, ModifyDBInstanceSpecResponse, RefreshAccountPasswordResponse, DescribeBaseBackupsResponse, DescribeDBXlogsResponse, ModifyDBInstanceChargeTypeResponse, DescribeBaseBackupsRequest, DescribeEncryptionKeysResponse, CreateReadOnlyGroupNetworkAccessResponse, DescribeRegionsResponse, DeleteAccountResponse, DescribeAuditLogsResponse } from "./postgres_models";
/**
 * postgres client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    DescribeDBProxySSLConfig(req: DescribeDBProxySSLConfigRequest, cb?: (error: string, rep: DescribeDBProxySSLConfigResponse) => void): Promise<DescribeDBProxySSLConfigResponse>;
    /**
     * 本接口（DescribePostgRestService）用于查询某个实例的PostgREST服务信息
     */
    DescribePostgRESTService(req: DescribePostgRESTServiceRequest, cb?: (error: string, rep: DescribePostgRESTServiceResponse) => void): Promise<DescribePostgRESTServiceResponse>;
    /**
     ...
     */
    CloseDBProxyAddress(req: CloseDBProxyAddressRequest, cb?: (error: string, rep: CloseDBProxyAddressResponse) => void): Promise<CloseDBProxyAddressResponse>;
    /**
...
- 不可逆操作：数据库一经删除，数据将无法恢复。执行前请确认已做好必要的数据备份。
     ...
     */
    OpenMem0Service(req: OpenMem0ServiceRequest, cb?: (error: string, rep: OpenMem0ServiceResponse) => void): Promise<OpenMem0ServiceResponse>;
    /**
     ...
     */
    OpenPostgRESTService(req: OpenPostgRESTServiceRequest, cb?: (error: string, rep: OpenPostgRESTServiceResponse) => void): Promise<OpenPostgRESTServiceResponse>;
    /**
...
<li>半同步实例使用同步复制或异步复制的条件配置</li>
     ...
     */
    DescribeMem0Service(req: DescribeMem0ServiceRequest, cb?: (error: string, rep: DescribeMem0ServiceResponse) => void): Promise<DescribeMem0ServiceResponse>;
    /**
     * 查询审计日志文件
     */
...
<li>半同步实例使用同步复制或异步复制的条件配置</li>
     ...
     */
    ClosePostgRESTService(req: ClosePostgRESTServiceRequest, cb?: (error: string, rep: ClosePostgRESTServiceResponse) => void): Promise<ClosePostgRESTServiceResponse>;
    /**
...
<li>只有主实例可以执行该操作</li>
     ...
     */
    CreateDBProxyAddress(req: CreateDBProxyAddressRequest, cb?: (error: string, rep: CreateDBProxyAddressResponse) => void): Promise<CreateDBProxyAddressResponse>;
    /**
     * 修改数据库实例的审计功能
     */
     ...
     */
    ModifyDBProxySSLConfig(req: ModifyDBProxySSLConfigRequest, cb?: (error: string, rep: ModifyDBProxySSLConfigResponse) => void): Promise<ModifyDBProxySSLConfigResponse>;
    /**
...
<li>预付费实例的购买会预先扣除本次实例购买所需金额，按小时后付费实例购买会预先冻结本次实例购买一小时内所需金额，在调用本接口前请确保账户余额充足。</li>
     ...
     */
    CloseMem0Service(req: CloseMem0ServiceRequest, cb?: (error: string, rep: CloseMem0ServiceResponse) => void): Promise<CloseMem0ServiceResponse>;
    /**
