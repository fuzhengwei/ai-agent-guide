...
默认接口请求频率限制：10次/秒。
     ...
     */
    DescribeQuestionSplitJob(req: DescribeQuestionSplitJobRequest, cb?: (error: string, rep: DescribeQuestionSplitJobResponse) => void): Promise<DescribeQuestionSplitJobResponse>;
    /**
...
默认接口请求频率限制：10次/秒。
     ...
     */
    VerifyGeneralCardWarn(req: VerifyGeneralCardWarnRequest, cb?: (error: string, rep: VerifyGeneralCardWarnResponse) => void): Promise<VerifyGeneralCardWarnResponse>;
    /**
...
按周更新企业信息变更情况，如遇到未及时更新的情况，可联系在线客服转产品团队进行人工处理。
     ...
     * 异步试卷切题识别可将整页练习册、试卷或教辅中的题目进行自动切题，并识别出其中的文字内容和坐标位置，是试卷切题的接口补充。主要解决试卷录题这类多页场景、单题跨页场景。需要 SubmitQuestionSplitOCRJob（提交任务）、DescribeQuestionSplitOCRJob（查询任务）两个接口配套使用，计费发生在提交任务后。
     */
    SubmitQuestionSplitJob(req: SubmitQuestionSplitJobRequest, cb?: (error: string, rep: SubmitQuestionSplitJobResponse) => void): Promise<SubmitQuestionSplitJobResponse>;
    /**
