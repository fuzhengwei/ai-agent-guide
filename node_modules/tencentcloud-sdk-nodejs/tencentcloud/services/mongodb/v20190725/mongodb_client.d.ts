...
**说明：DropDBInstanceParamTpl  API正在公测中，在此期间，该接口仅对公测用户开放**
     ...
     * 手动开启cpu弹性扩容
     */
    ScaleUpDBInstanceCpu(req: ScaleUpDBInstanceCpuRequest, cb?: (error: string, rep: ScaleUpDBInstanceCpuResponse) => void): Promise<ScaleUpDBInstanceCpuResponse>;
    /**
...
**说明：DescribeDBInstanceParamTpl  API正在公测中，在此期间，该接口仅对公测用户开放**
     ...
     * 查询cpu弹性扩容信息
     */
    CheckDBInstanceElasticCpuScalable(req: CheckDBInstanceElasticCpuScalableRequest, cb?: (error: string, rep: CheckDBInstanceElasticCpuScalableResponse) => void): Promise<CheckDBInstanceElasticCpuScalableResponse>;
    /**
     ...
     */
    ScaleDownDBInstanceCpu(req: ScaleDownDBInstanceCpuRequest, cb?: (error: string, rep: ScaleDownDBInstanceCpuResponse) => void): Promise<ScaleDownDBInstanceCpuResponse>;
    /**
