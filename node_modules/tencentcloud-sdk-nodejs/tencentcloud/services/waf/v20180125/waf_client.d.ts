...
export declare class Client extends AbstractClient {
     ...
     * 批量cc规则配置接口
     */
    CreateAndUpdateBatchCCRule(req: CreateAndUpdateBatchCCRuleRequest, cb?: (error: string, rep: CreateAndUpdateBatchCCRuleResponse) => void): Promise<CreateAndUpdateBatchCCRuleResponse>;
    /**
     * 获取一个clbwaf域名详情
     */
     ...
     * 查询是否开启透传客户端信息
     */
    QueryClientMsg(req: QueryClientMsgRequest, cb?: (error: string, rep: QueryClientMsgResponse) => void): Promise<QueryClientMsgResponse>;
    /**
...
支持批量操作。
     ...
     */
    EnableClientMsg(req: EnableClientMsgRequest, cb?: (error: string, rep: EnableClientMsgResponse) => void): Promise<EnableClientMsgResponse>;
    /**
     * 编辑精准白名单
     */
