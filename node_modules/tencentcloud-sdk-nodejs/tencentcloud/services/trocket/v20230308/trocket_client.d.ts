...
import { DescribeProductSKUsRequest, CreateMigrationTaskRequest, ResetConsumerGroupOffsetResponse, DescribeSmoothMigrationTaskListRequest, CreateConsumerLabelsRequest, DescribeConsumerRouteVersionListResponse, DescribeRoleListResponse, CreateConsumerLabelResponse, DescribeConsumerRouteConfigRequest, CreateInstanceResponse, DescribeMessageListRequest, ModifyInstanceRequest, DescribeConsumerLabelListsRequest, DescribeConsumerGroupResponse, ImportSourceClusterConsumerGroupsResponse, DeleteTopicRequest, DescribeTopicStatsRequest, PutConsumerRouteConfigsResponse, DescribeSmoothMigrationTaskListResponse, DescribeMigrationTaskListResponse, DeleteConsumerRouteConfigResponse, DescribeRoleListRequest, DescribeConsumerLabelResponse, ImportSourceClusterConsumerGroupsRequest, DescribeConsumerLagRequest, SendMessageRequest, DescribeMigratingTopicStatsResponse, DescribeMigratingGroupStatsRequest, DescribeSourceClusterGroupListResponse, DescribeMessageListResponse, DeleteSmoothMigrationTaskRequest, DescribeInstanceListResponse, DescribeConsumerClientListResponse, ModifyInstanceResponse, CreateConsumerGroupRequest, ChangeMigratingTopicToNextStageResponse, DescribeSourceClusterGroupListRequest, DescribeConsumerLabelRequest, DeleteConsumerLabelsResponse, DescribeConsumerRouteConfigResponse, DescribeMigrationTaskListRequest, VerifyMessageConsumptionResponse, ModifyRoleResponse, ImportSourceClusterTopicsRequest, DeleteInstanceResponse, DescribeTopicResponse, DeleteConsumerRouteConfigsResponse, ModifyRoleRequest, DescribeTopicStatsResponse, DescribeMessageRequest, CreateTopicRequest, DescribeFusionInstanceListResponse, DeleteRoleRequest, ResendDeadLetterMessageResponse, ModifyConsumerGroupResponse, DescribeConsumerLabelListRequest, DeleteConsumerGroupRequest, CreateConsumerGroupResponse, DescribeTopicListByGroupResponse, DescribeMessageTraceResponse, DoHealthCheckOnMigratingTopicRequest, DescribeProducerListRequest, DescribeMigratingTopicListResponse, VerifyMessageConsumptionRequest, DescribeTopicRequest, DescribeMessageTraceRequest, DeleteSmoothMigrationTaskResponse, CreateTopicResponse, DescribeMigratingGroupStatsResponse, RemoveMigratingTopicRequest, DescribeMessageResponse, ImportSourceClusterTopicsResponse, DescribeTopicListRequest, DescribeMigratingTopicStatsRequest, DescribeConsumerRouteConfigsRequest, PutConsumerRouteConfigsRequest, ModifyConsumerGroupRequest, DescribeConsumerGroupRequest, DescribeConsumerGroupListRequest, CreateInstanceRequest, DescribeConsumerClientRequest, ModifyTopicResponse, DeleteConsumerLabelsRequest, SendMessageResponse, CreateRoleResponse, ChangeMigratingTopicToNextStageRequest, DeleteRoleResponse, DescribeTopicListByGroupRequest, DescribeConsumerLabelListsResponse, DescribeMigratingTopicListRequest, ModifyTopicRequest, RollbackMigratingTopicStageRequest, DescribeInstanceResponse, DescribeConsumerClientResponse, DeleteInstanceRequest, DescribeProducerListResponse, ResendDeadLetterMessageRequest, DescribeConsumerLabelListResponse, RollbackMigratingTopicStageResponse, DescribeFusionInstanceListRequest, DescribeConsumerRouteConfigsResponse, DoHealthCheckOnMigratingTopicResponse, DeleteConsumerRouteConfigRequest, DeleteConsumerLabelResponse, DescribeConsumerLagResponse, ModifyInstanceEndpointRequest, CreateMigrationTaskResponse, CreateConsumerLabelRequest, DescribeTopicListResponse, PutConsumerRouteConfigResponse, DescribeConsumerClientListRequest, DescribeInstanceListRequest, CreateRoleRequest, DeleteConsumerGroupResponse, DescribeConsumerLabelRoutesRequest, DescribeConsumerRouteVersionListRequest, DescribeConsumerGroupListResponse, DescribeProductSKUsResponse, PutConsumerRouteConfigRequest, DescribeConsumerLabelRoutesResponse, DeleteTopicResponse, DeleteConsumerRouteConfigsRequest, ModifyInstanceEndpointResponse, DescribeInstanceRequest, CreateConsumerLabelsResponse, RemoveMigratingTopicResponse, DeleteConsumerLabelRequest, ResetConsumerGroupOffsetRequest } from "./trocket_models";
/**
 * trocket client
 * @class
 */
...
[{
     ...
     * 批量删除消费组灰度标签
     */
    DeleteConsumerLabels(req: DeleteConsumerLabelsRequest, cb?: (error: string, rep: DeleteConsumerLabelsResponse) => void): Promise<DeleteConsumerLabelsResponse>;
    /**
     * 写入消费组灰度路由配置
     */
...
当前 API 适用集群：5.x 集群。4.x 集群的查询角色列表接口文档见 [DescribeRocketMQRoles](https://cloud.tencent.com/document/product/1179/107534)，查询角色授权列表接口文档见 [DescribeRocketMQEnvironmentRoles](https://cloud.tencent.com/document/product/1179/107535)。
     ...
     */
    DescribeConsumerLabelRoutes(req: DescribeConsumerLabelRoutesRequest, cb?: (error: string, rep: DescribeConsumerLabelRoutesResponse) => void): Promise<DescribeConsumerLabelRoutesResponse>;
    /**
     * 查询消息详情。
...
当前 API 适用集群：5.x 集群。4.x 集群的删除角色接口文档见 [DeleteRocketMQRoles](https://cloud.tencent.com/document/product/1179/107536)，删除角色授权接口文档见 [DeleteRocketMQEnvironmentRoles](https://cloud.tencent.com/document/product/1179/107537)。
     ...
     * 批量查询多个消费组的灰度标签列表
     */
    DescribeConsumerLabelLists(req: DescribeConsumerLabelListsRequest, cb?: (error: string, rep: DescribeConsumerLabelListsResponse) => void): Promise<DescribeConsumerLabelListsResponse>;
    /**
...
当前 API 适用集群：4.x 集群和 5.x 集群。
     ...
     * 批量删除消费组灰度路由配置
     */
    DeleteConsumerRouteConfigs(req: DeleteConsumerRouteConfigsRequest, cb?: (error: string, rep: DeleteConsumerRouteConfigsResponse) => void): Promise<DeleteConsumerRouteConfigsResponse>;
    /**
     * 查询消费组详情。
...
当前 API 适用集群：5.x 集群。查询 4.x 专享/通用集群信息的接口文档见 [DescribeRocketMQVipInstanceDetail](https://cloud.tencent.com/document/product/1179/86725)。
     ...
     * 批量查询消费组灰度路由配置
     */
    DescribeConsumerRouteConfigs(req: DescribeConsumerRouteConfigsRequest, cb?: (error: string, rep: DescribeConsumerRouteConfigsResponse) => void): Promise<DescribeConsumerRouteConfigsResponse>;
    /**
     * 重新发送死信消息。
当前 API 适用集群：5.x集群。4.x 集群的重发死信消息接口文档见 [RetryRocketMQDlqMessage](https://cloud.tencent.com/document/api/1179/114595)。
     ...
     * 批量写入消费组灰度路由配置
     */
    PutConsumerRouteConfigs(req: PutConsumerRouteConfigsRequest, cb?: (error: string, rep: PutConsumerRouteConfigsResponse) => void): Promise<PutConsumerRouteConfigsResponse>;
    /**
     * 查询消费组灰度路由配置版本列表
     */
...
当前 API 适用集群：5.x 集群。4.x 集群的查询生产者客户端列表接口文档见 [DescribeRocketMQProducers](https://cloud.tencent.com/document/api/1179/122749)。
     ...
     * 批量创建消费组灰度标签
     */
    CreateConsumerLabels(req: CreateConsumerLabelsRequest, cb?: (error: string, rep: CreateConsumerLabelsResponse) => void): Promise<CreateConsumerLabelsResponse>;
    /**
