...
export declare class Client extends AbstractClient {
     ...
     */
    CloneVoiceAsync(req: CloneVoiceAsyncRequest, cb?: (error: string, rep: CloneVoiceAsyncResponse) => void): Promise<CloneVoiceAsyncResponse>;
    /**
...
创建视频重生模板。
     ...
     */
    CloneVoiceSync(req: CloneVoiceSyncRequest, cb?: (error: string, rep: CloneVoiceSyncResponse) => void): Promise<CloneVoiceSyncResponse>;
    /**
     * 查询轮播当前播放列表。
     */
...
>模板仅适用于 [音视频审核(ReviewAudioVideo)](https://cloud.tencent.com/document/api/266/80283) 和 [图片审核(ReviewImage)](https://cloud.tencent.com/document/api/266/73217) 接口。
     ...
     * 发起语音合成任务，将文本合成为语音。
     */
    TextToSpeechSync(req: TextToSpeechSyncRequest, cb?: (error: string, rep: TextToSpeechSyncResponse) => void): Promise<TextToSpeechSyncResponse>;
    /**
...
2. 可以指定回包只返回部分信息。
     ...
     */
    CreateAigcHunyuan3DTask(req: CreateAigcHunyuan3DTaskRequest, cb?: (error: string, rep: CreateAigcHunyuan3DTaskResponse) => void): Promise<CreateAigcHunyuan3DTaskResponse>;
    /**
     * 该 API 已经<font color=red>不再维护</font>，请使用新版接口 [音画质重生](https://cloud.tencent.com/document/api/266/102571)。
使用模板发起视频重生。
     */
