...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 删除控制台用户组
     */
    async DeleteConsoleGroups(req, cb) {
...
| `InternalError` | 1030900 | 服务内部异常 | 请携带 RequestId 联系支持 |
     ...
     * 创建控制台用户组
     */
    async CreateConsoleGroup(req, cb) {
     ...
     */
    async RemoveConsoleUsers(req, cb) {
     ...
     * 查询控制台用户组列表
     */
    async ListConsoleGroups(req, cb) {
        return this.request("ListConsoleGroups", req, cb);
    }
    /**
     * 查询控制台角色列表
     */
    async ListConsoleRoles(req, cb) {
     ...
     * 修改控制台用户组
     */
    async UpdateConsoleGroup(req, cb) {
...
| `InternalError` | 1030900 | 服务内部异常 | 请携带 RequestId 联系支持 |
     ...
     * 修改控制台用户角色
     */
    async UpdateConsoleUsers(req, cb) {
...
5. 需带文件内容创建时通过 Storage 传入（大文件走 COS 中转，小文件放 Storage.Content）。
     ...
     * 查询控制台用户组成员列表
     */
    async ListConsoleGroupUsers(req, cb) {
