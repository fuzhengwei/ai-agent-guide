...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeJobDetail(req: DescribeJobDetailRequest, cb?: (error: string, rep: DescribeJobDetailResponse) => void): Promise<DescribeJobDetailResponse>;
    /**
     * 查询指定文件夹及其相应的子文件夹信息
     */
