...
规则级自定义变量相关操作，请调用 CreateL7AccRules 或 ModifyL7AccRule 接口。
     */
    ModifyZoneCustomVariables(req: ModifyZoneCustomVariablesRequest, cb?: (error: string, rep: ModifyZoneCustomVariablesResponse) => void): Promise<ModifyZoneCustomVariablesResponse>;
    /**
...
<li>emc：Exclude mainlandChina.</li>
     */
    DescribeAvailableOriginACLFamily(req: DescribeAvailableOriginACLFamilyRequest, cb?: (error: string, rep: DescribeAvailableOriginACLFamilyResponse) => void): Promise<DescribeAvailableOriginACLFamilyResponse>;
    /**
     * 修改边缘函数触发规则的优先级。
     */
...
- 回源 IP 网段会不定期变更，EdgeOne 将在回源 IP 网段变更前 14 天、前 7 天、前 3 天和前 1 天分别通过站内信、短信、邮件等一种或多种方式发起通知，为了能正常收到回源 IP 网段的变更通知，请务必确保您在 [腾讯云消息中心控制台](https://console.cloud.tencent.com/message)内，已勾选边缘安全加速平台 EO 的产品服务相关消息通知，并配置正确的消息接收人。配置方式请参考 [消息订阅管理](https://cloud.tencent.com/document/product/567/43476)。
     ...
     * 查询站点规则引擎操作可用的定制配置列表。
     */
    DescribeAvailableCustomActionsForRuleEngine(req: DescribeAvailableCustomActionsForRuleEngineRequest, cb?: (error: string, rep: DescribeAvailableCustomActionsForRuleEngineResponse) => void): Promise<DescribeAvailableCustomActionsForRuleEngineResponse>;
    /**
...
如需查询规则级自定义变量，请调用 DescribeL7AccRules 接口。
     */
    DescribeZoneCustomVariables(req: DescribeZoneCustomVariablesRequest, cb?: (error: string, rep: DescribeZoneCustomVariablesResponse) => void): Promise<DescribeZoneCustomVariablesResponse>;
    /**
