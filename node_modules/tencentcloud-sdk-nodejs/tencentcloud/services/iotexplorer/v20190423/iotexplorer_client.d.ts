...
import { UpdateDevicesEnableStateResponse, DeleteTWeSeePersonResponse, DescribeCloudStoragePackageConsumeDetailsResponse, GetWechatDeviceTicketRequest, DeleteFenceBindRequest, DescribeModelDefinitionResponse, GetGatewaySubDeviceListResponse, DeleteStudioProductResponse, DescribeDevicePackagesRequest, DeleteLoRaFrequencyResponse, ModifyApplicationResponse, DescribeCsReportCountDataInfoRequest, CreateFreeCloudStorageResponse, DescribeTWeTalkProductConfigResponse, ModifyPositionFenceResponse, DescribeTWeSeeRecognitionTaskResponse, DescribeCloudStorageAIServiceTaskRequest, DescribeCloudStorageThumbnailListRequest, DescribeTWeSeeSubscriptionResponse, DescribeCloudStorageUsersResponse, CreateTWeSeePersonRequest, RevokeShareDeviceFromUserRequest, DescribeCloudStoragePackageConsumeDetailsRequest, BatchUpdateFirmwareResponse, DescribeActivateLicenseServiceResponse, RenewTWeSeeSubscriptionRequest, CreateCloudStorageAIServiceTaskRequest, DescribeCloudStorageOrderRequest, CreateTWeTalkAgentRequest, TransferTWeCallDeviceResponse, DescribeTWeSeeDirectUploadInfoResponse, GetTWeTalkProductConfigListRequest, DescribeSpaceFenceEventListResponse, CallDeviceRRPCSyncRequest, DescribeCloudStorageEventsWithAITasksResponse, SearchTopicRuleResponse, ImportTWeSeeFacesResponse, ModifyCloudStorageAIServiceResponse, InvokeTWeSeeComprehensionRequest, DescribeDeviceFirmWareRequest, BindCloudStorageUserRequest, UnbindTWeTalkAgentResponse, CreateLoRaFrequencyRequest, ChangeP2PRouteResponse, UpdateDeviceTWeCallAuthorizeStatusRequest, CreateTWeSeeDirectUploadCredentialResponse, CreateProjectResponse, DeleteProjectResponse, CallDeviceActionAsyncRequest, CreateDeviceResponse, CreateDeviceRequest, InheritCloudStorageUserResponse, DescribeFirmwareTasksRequest, DescribeDeviceResponse, DescribeCloudStorageEventsRequest, GetStudioProductListResponse, DestroyTWeSeeSubscriptionResponse, GetTWeCallActiveStatusRequest, GetAuthMiniProgramAppListRequest, DescribeFenceEventListRequest, DescribeAISearchTaskAsyncRequest, DescribeTWeSeeSubscriptionRequest, ActivateTWeTalkResponse, ActivateTWeCallLicenseResponse, ActivateTWeTalkRequest, ListTWeSeeTasksResponse, DescribeProductDynamicRegisterRequest, DeleteTopicPolicyRequest, InquireTWeSeeSubscriptionCreatePriceRequest, ResetCloudStorageEventRequest, CreateTWeTalkAIBotResponse, DeleteTWeSeeCallbackResponse, DescribeTWeTalkAgentListResponse, DescribeTWeSeeTaskStatisticsResponse, GetFamilyDeviceUserListRequest, CreateTRTCSignaturesWithRoomIdRequest, DescribeSpaceFenceEventListRequest, CreateTWeSeeCallbackResponse, DescribeUnbindedDevicesRequest, DescribeVodCloudStorageDateResponse, InvokeAISearchServiceResponse, ModifyTWeSeeConfigRequest, DescribeGatewaySubDeviceListRequest, ModifyTWeSeeSubscriptionRenewFlagRequest, GetDeviceListRequest, DescribeDeviceDataHistoryRequest, DescribeStudioProductRequest, CreateTWeSeeDirectUploadCredentialRequest, OperateTWeSeeDirectUploadObjectRequest, DescribeCloudStorageThumbnailListResponse, DeletePositionFenceRequest, ListTWeSeeCallbackRequest, GetProjectListRequest, ModifyPositionSpaceRequest, DescribeDeviceBindGatewayRequest, GetTWeTalkProductConfigListV2Response, DeleteDevicesRequest, BindTWeTalkAgentRequest, ModifyProjectResponse, DescribeCloudStorageThumbnailRequest, ModifyProductCloudStorageAIServiceRequest, CreateExternalSourceAIServiceTaskRequest, DescribeCloudStorageAIServiceCallbackResponse, InheritCloudStorageUserRequest, ModifyProjectRequest, ModifySpacePropertyResponse, PauseTWeCallDeviceRequest, ModifyTWeSeePersonResponse, ModifyTWeSeeCallbackResponse, DescribeDeviceDataHistoryResponse, CreateTWeSeeRecognitionTaskWithFileResponse, GetTWeTalkActiveRecordListRequest, DescribeTWeSeeFaceRequest, GetBatchProductionsListRequest, DeleteDeviceResponse, ModifyLoRaFrequencyResponse, InvokeTWeSeeRecognitionTaskWithFileResponse, GetBatchProductionsListResponse, DescribeGatewayBindDevicesResponse, DescribeDeviceFirmwaresResponse, DescribeCloudStorageUsersRequest, UpdateFirmwareResponse, DescribeCloudStorageDateRequest, CreateTWeSeeRecognitionTaskWithFileRequest, DescribeTopicPolicyRequest, DescribeDeviceFirmwaresRequest, UnbindDevicesRequest, PublishBroadcastMessageRequest, DeleteCloudStorageEventResponse, ModifyProductDynamicRegisterResponse, DescribeCloudStorageTimeResponse, GetPositionSpaceListRequest, DescribeGatewaySubProductsResponse, BindProductsResponse, GetDeviceListResponse, DescribeCloudStorageMultiThumbnailResponse, CheckFirmwareUpdateResponse, ListTWeSeeTasksRequest, InquireTWeSeeSubscriptionRenewPriceResponse, DescribeFreeCloudStorageNumRequest, ModifyTWeTalkAIBotRequest, DescribeDevicePositionListRequest, DeleteOtaModuleRequest, CreateStudioProductRequest, TransferCloudStorageRequest, CreateTWeSeeServiceRequest, UploadFirmwareRequest, DescribeFirmwareRequest, RevokeShareDeviceFromUserResponse, DescribeGatewayBindDevicesRequest, RevokeBindUserDeviceRequest, ModifyTWeTalkProductConfigV2Response, DescribeP2PRouteResponse, ListTopicPolicyResponse, CreateTWeTalkAgentResponse, CreateAISearchTaskAsyncRequest, GenSingleDeviceSignatureOfPublicResponse, DeleteTWeTalkProductConfigV2Request, SearchStudioProductResponse, DescribeTWeTalkAIBotResponse, ModifyTWeSeeSubscriptionResponse, ModifyTWeSeeFaceRequest, CreateTWeSeeSubscriptionResponse, DescribeBatchProductionResponse, DescribeProductCloudStorageAIServiceResponse, DescribeLoRaFrequencyRequest, ModifyTWeTalkProductConfigResponse, ModifyTWeSeeSubscriptionRequest, CreateTWeSeeCallbackRequest, GetTWeTalkActiveRecordListResponse, DeleteCloudStorageEventRequest, SearchPositionSpaceRequest, DescribeTWeTalkAIBotRequest, ModifyLoRaGatewayResponse, CallDeviceActionSyncResponse, CreateLoRaGatewayRequest, ModifyTopicRuleRequest, CreateTWeSeeServiceResponse, CreateAISearchTaskAsyncResponse, DescribeFenceBindListResponse, TransferTWeCallDeviceRequest, RenewTWeSeeSubscriptionResponse, CreateTWeSeeRecognitionTaskResponse, UnbindProductsRequest, GetTWeTalkProductConfigListV2Request, CreateCloudStorageAIServiceRequest, DescribeTWeSeeCallbackResponse, DescribeStudioProductResponse, CreateIotVideoCloudStorageResponse, DescribePackageConsumeTaskResponse, CheckFirmwareUpdateRequest, DescribeTWeTalkAgentBindingResponse, RemoveUserByRoomIdFromTRTCRequest, DescribeTWeSeePostPaidServiceResponse, ModifyPositionSpaceResponse, ModifyCloudStorageAIServiceCallbackResponse, BatchRenewTWeSeeSubscriptionRequest, DescribeTWeSeeDirectUploadInfoRequest, BatchCreateTWeSeeSubscriptionResponse, ListTWeSeeCallbackResponse, GetVodCloudStorageEventListResponse, DeleteTWeTalkAgentRequest, CreateFenceBindResponse, DescribeBindedProductsResponse, ModifyTopicRuleResponse, BatchRenewTWeSeeSubscriptionResponse, DescribeBatchProductionRequest, DirectBindDeviceInFamilyRequest, DescribeCloudStorageAIServiceTaskResponse, PublishRRPCMessageResponse, InquireTWeSeeSubscriptionCreatePriceResponse, CreateTWeTalkProductConfigV2Request, DescribeInstanceResponse, DeleteTWeSeeTasksByConditionRequest, DescribeProjectRequest, GetTWeTalkAIBotListResponse, UploadFirmwareResponse, ModifyTopicPolicyRequest, DeleteTopicRuleRequest, CreateLoRaGatewayResponse, ModifyTWeSeeFaceResponse, DescribeDeviceBindGatewayResponse, BindUserDeviceResponse, ControlDeviceDataResponse, ListTWeSeePersonsRequest, CreatePositionSpaceResponse, CreateTWeTalkProductConfigResponse, ListProductOtaModulesResponse, ResetCloudStorageEventResponse, DescribeCloudStorageAIServiceTasksResponse, DeletePositionSpaceResponse, PauseTWeCallDeviceResponse, DescribeActivateDeviceResponse, ResetTWeCallDeviceResponse, DescribeTWeSeePersonResponse, DescribeCloudStorageResponse, ModifyTWeSeePersonRequest, DescribeCloudStorageStreamDataRequest, ListEventHistoryResponse, DescribeTWeSeeFaceResponse, BatchCreateTWeSeeRecognitionTaskRequest, PublishMessageResponse, DescribeModelDefinitionRequest, DisableTopicRuleRequest, DescribeTWeSeeConfigRequest, CreateTopicRuleResponse, DescribeDeviceDataResponse, DescribePositionFenceListRequest, DescribeUnbindedDevicesResponse, DescribeBindedProductsRequest, InvokeCloudStorageAIServiceTaskRequest, GetTWeTalkProductConfigListResponse, CreateDevicePublishSDPAnswerRequest, DescribeSubscribedTopicPolicyResponse, ResetCloudStorageRequest, DescribeCloudStorageEventsWithAITasksRequest, GetTWeTalkActiveStatusResponse, DescribeCloudStorageTimeRequest, DescribeVideoLicenseRequest, DescribeCloudStorageAIServiceResponse, InvokeAISearchServiceRequest, DescribeTWeSeeTaskResponse, DeleteDevicesResponse, ModifyStudioProductResponse, BindDevicesRequest, DescribePackageConsumeTaskRequest, DismissRoomByStrRoomIdFromTRTCResponse, DescribeFirmwareUpdateStatusResponse, PublishFirmwareUpdateMessageResponse, UnbindProductsResponse, GetVodCloudStorageVideoListResponse, UnbindTWeTalkAIBotResponse, CallDeviceActionSyncRequest, GetLoRaGatewayListRequest, DeleteTWeSeeFaceResponse, ResetCloudStorageAIServiceResponse, DescribeCloudStorageEventsByTWeSeePersonResponse, DeleteTWeSeeCallbackRequest, CreateTWeSeeRecognitionTaskRequest, UpdateOtaTaskStatusRequest, ModifyFenceBindResponse, UnbindTWeTalkAIBotRequest, DescribeTWeSeeTaskStatisticsRequest, DeletePositionFenceResponse, DestroyTWeSeeSubscriptionRequest, GetTWeCallActiveStatusResponse, GetAuthMiniProgramAppListResponse, UpdateOtaModuleResponse, UpdateDeviceTWeCallAuthorizeStatusResponse, ModifyProductCloudStorageAIServiceResponse, ModifyTWeSeeConfigResponse, GetDeviceLocationHistoryRequest, DeletePositionSpaceRequest, DescribeActivateDeviceRequest, CreateProjectRequest, CreateCloudStorageAIServiceResponse, ModifyTWeSeeCallbackRequest, DescribeTWeSeeCallbackRequest, DescribeSubscribedTopicPolicyRequest, BatchInvokeTWeSeeRecognitionTaskRequest, InvokeTWeSeeRecognitionTaskRequest, ModifyProductDynamicRegisterRequest, DeleteDeviceRequest, CreateDeviceSDPAnswerRequest, ControlDeviceDataRequest, ListFirmwaresResponse, ReleaseStudioProductResponse, DescribeFirmwareResponse, DescribePackageConsumeTasksResponse, CallDeviceRRPCSyncResponse, DescribeTopicPolicyResponse, InvokeCloudStorageAIServiceTaskResponse, DescribeTWeSeeTaskRequest, InvokeTWeSeeRecognitionTaskResponse, DescribeDeviceFirmWareResponse, DescribeFenceEventListResponse, DescribeTWeSeePostPaidServiceRequest, ModifyTWeTalkProductConfigRequest, DescribeVodCloudStorageDateRequest, DescribeCsReportCountDataInfoResponse, DescribeTWeTalkAgentBindingRequest, ModifyCloudStorageAIServiceRequest, DescribeTWeSeeConfigResponse, GetProjectListResponse, BatchDescribeTWeSeeOrdersRequest, GetStudioProductListRequest, DescribeFirmwareTaskResponse, DisableTopicRuleResponse, DescribeCloudStorageAIServiceTasksRequest, DescribeTWeTalkAgentRequest, ListFirmwaresRequest, PublishMessageRequest, DescribeFirmwareTaskDevicesResponse, UnbindDevicesResponse, ModifySpacePropertyRequest, GetCOSURLResponse, GetTopicRuleListResponse, SearchPositionSpaceResponse, GenerateCloudStorageAIServiceTaskFileURLResponse, ChangeP2PRouteRequest, CreateTWeSeePostPaidServiceResponse, ResetTWeCallDeviceRequest, CreateTopicPolicyResponse, CallDeviceActionAsyncResponse, DescribeTWeTalkAgentResponse, TerminateTWeSeeSubscriptionRequest, ModifyTWeSeeSubscriptionRenewFlagResponse, GetPositionSpaceListResponse, CreatePositionFenceResponse, DescribeTopicRuleResponse, UpdateFirmwareRequest, InvokeTWeSeeRecognitionTaskWithFileRequest, DescribeDeviceRequest, OperateTWeSeeDirectUploadObjectResponse, ListOtaModulesResponse, CreateDeviceChannelRequest, DescribeDevicePackagesResponse, DescribeTWeTalkAgentListRequest, DeleteDeviceSDPRequest, DescribeGatewaySubDeviceListResponse, CreateOtaModuleRequest, DescribeVideoLicenseResponse, DescribePackageConsumeTasksRequest, GetFamilyDeviceUserListResponse, UnbindTWeTalkAgentRequest, DeleteLoRaGatewayResponse, DeleteTWeTalkAgentResponse, BindTWeTalkAIBotRequest, UpdateOtaModuleRequest, ModifyLoRaFrequencyRequest, InvokeVideosKeywordsAnalyzerResponse, DescribeTWeTalkProductConfigV2Request, ModifyTWeTalkAIBotResponse, CreateLoRaFrequencyResponse, EnableTopicRuleResponse, GetGatewaySubDeviceListRequest, SearchStudioProductRequest, CreateDevicePublishSDPAnswerResponse, GenSingleDeviceSignatureOfPublicRequest, DescribeCloudStorageEventsByTWeSeePersonRequest, BatchCreateTWeSeeRecognitionTaskResponse, DescribeTWeSeePersonRequest, DescribeGatewaySubProductsRequest, InquireTWeSeeSubscriptionRenewPriceRequest, CreateExternalSourceAIServiceTaskResponse, BindProductsRequest, TerminateTWeSeeSubscriptionResponse, CreateTWeTalkProductConfigRequest, ModifyPositionFenceRequest, BindDevicesResponse, BatchDescribeTWeSeeOrdersResponse, InvokeExternalSourceAIServiceTaskResponse, DescribeCloudStorageAIServiceRequest, DeleteTWeSeeTasksByConditionResponse, DescribeCloudStorageOrderResponse, DescribeActivateLicenseServiceRequest, CreateTRTCSignaturesWithRoomIdResponse, DescribeTWeTalkProductConfigV2Response, DescribeInstanceRequest, ModifyTWeTalkAgentResponse, ShareDeviceToUserRequest, CreatePositionSpaceRequest, ImportTWeSeeFacesRequest, BindUserDeviceRequest, DeleteProjectRequest, DescribeLicenseOverviewRequest, DeleteTWeTalkProductConfigV2Response, BatchInvokeTWeSeeRecognitionTaskResponse, BindTWeTalkAIBotResponse, DeleteTopicRuleResponse, ModifyModelDefinitionRequest, ListTWeSeePersonsResponse, TransferCloudStorageResponse, CreateStudioProductResponse, DeleteOtaModuleResponse, ModifyStudioProductRequest, CreateBatchProductionRequest, ReleaseStudioProductRequest, DescribeCloudStoragePackageConsumeStatsResponse, ListEventHistoryRequest, SearchTopicRuleRequest, DescribeDeviceDataRequest, ListProductOtaModulesRequest, DescribePositionFenceListResponse, DescribeCloudStorageMultiThumbnailRequest, DescribeFirmwareUpdateStatusRequest, GetDeviceSumStatisticsResponse, DescribeDevicePositionListResponse, DescribeProjectResponse, CreateTWeTalkProductConfigV2Response, DescribeLicenseOverviewResponse, ListTopicPolicyRequest, DeleteLoRaFrequencyRequest, InvokeVideosKeywordsAnalyzerRequest, DescribeFirmwareTaskDevicesRequest, InvokeExternalSourceAIServiceTaskRequest, DescribeProductCloudStorageAIServiceRequest, DeleteLoRaGatewayRequest, DeleteTWeTalkAIBotRequest, ModifyTopicPolicyResponse, DescribeCloudStorageStreamDataResponse, BatchCreateTWeSeeSubscriptionRequest, DescribeTopicRuleRequest, ModifyCloudStorageAIServiceCallbackRequest, GetWechatDeviceTicketResponse, ResumeWeCallDeviceResponse, ResetCloudStorageResponse, CreatePositionFenceRequest, ResumeWeCallDeviceRequest, GetCOSURLRequest, CreateTWeSeeSubscriptionRequest, CreateFenceBindRequest, CreateTWeTalkAIBotRequest, DescribeTWeTalkProductConfigRequest, DescribeFirmwareTasksResponse, GetVodCloudStorageVideoListRequest, GetDeviceLocationHistoryResponse, ModifyFenceBindRequest, InvokeTWeSeeComprehensionResponse, GetVodCloudStorageEventListRequest, GetLoRaGatewayListResponse, GetTWeTalkActiveStatusRequest, DirectBindDeviceInFamilyResponse, DescribeCloudStoragePackageConsumeStatsRequest, DeleteFenceBindResponse, ActivateTWeCallLicenseRequest, DescribeAISearchTaskAsyncResponse, DeleteDeviceSDPResponse, PublishBroadcastMessageResponse, DescribeFenceBindListRequest, GenerateSignedVideoURLRequest, CreateDeviceChannelResponse, CreateTopicRuleRequest, CreateTopicPolicyRequest, DescribeTWeSeeRecognitionTaskRequest, DeleteTWeSeePersonRequest, DescribeCloudStorageEventsResponse, CreateTWeSeePersonResponse, CreateFreeCloudStorageRequest, DescribeLoRaFrequencyResponse, CreateCloudStorageAIServiceTaskResponse, ModifyApplicationRequest, DescribeCloudStorageDateResponse, DescribeFreeCloudStorageNumResponse, CreateIotVideoCloudStorageRequest, GenerateCloudStorageAIServiceTaskFileURLRequest, ShareDeviceToUserResponse, BindCloudStorageUserResponse, DeleteTopicPolicyResponse, BindTWeTalkAgentResponse, CreateOtaModuleResponse, ModifyTWeTalkAgentRequest, CreateBatchProductionResponse, BatchUpdateFirmwareRequest, GetTWeTalkAIBotListRequest, GetTopicRuleListRequest, ListOtaModulesRequest, RevokeBindUserDeviceResponse, CreateDeviceSDPAnswerResponse, DeleteStudioProductRequest, DescribeP2PRouteRequest, GetDeviceSumStatisticsRequest, DescribeCloudStorageAIServiceCallbackRequest, DescribeCloudStorageRequest, GenerateSignedVideoURLResponse, CreateTWeSeePostPaidServiceRequest, DeleteTWeSeeFaceRequest, DescribeCloudStorageThumbnailResponse, DescribeProductDynamicRegisterResponse, PublishFirmwareUpdateMessageRequest, UpdateDevicesEnableStateRequest, DeleteTWeTalkAIBotResponse, ResetCloudStorageAIServiceRequest, UpdateOtaTaskStatusResponse, ModifyModelDefinitionResponse, ModifyTWeTalkProductConfigV2Request, RemoveUserByRoomIdFromTRTCResponse, ModifyLoRaGatewayRequest, DismissRoomByStrRoomIdFromTRTCRequest, EnableTopicRuleRequest, PublishRRPCMessageRequest, DescribeFirmwareTaskRequest } from "./iotexplorer_models";
/**
 * iotexplorer client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 查询 TWeSee 预付费新购价格
     */
    InquireTWeSeeSubscriptionCreatePrice(req: InquireTWeSeeSubscriptionCreatePriceRequest, cb?: (error: string, rep: InquireTWeSeeSubscriptionCreatePriceResponse) => void): Promise<InquireTWeSeeSubscriptionCreatePriceResponse>;
    /**
     ...
     */
    DeleteTWeSeePerson(req: DeleteTWeSeePersonRequest, cb?: (error: string, rep: DeleteTWeSeePersonResponse) => void): Promise<DeleteTWeSeePersonResponse>;
    /**
     ...
     * 查询 TWeSee 直传信息
     */
    DescribeTWeSeeDirectUploadInfo(req: DescribeTWeSeeDirectUploadInfoRequest, cb?: (error: string, rep: DescribeTWeSeeDirectUploadInfoResponse) => void): Promise<DescribeTWeSeeDirectUploadInfoResponse>;
    /**
     * 续费 TWeSee 预付费订阅
     */
    RenewTWeSeeSubscription(req: RenewTWeSeeSubscriptionRequest, cb?: (error: string, rep: RenewTWeSeeSubscriptionResponse) => void): Promise<RenewTWeSeeSubscriptionResponse>;
    /**
     * Owner 取消对指定用户的设备分享：
...
4. 删除分享关系记录（不存在视为已取消，幂等成功）。
     */
    RevokeShareDeviceFromUser(req: RevokeShareDeviceFromUserRequest, cb?: (error: string, rep: RevokeShareDeviceFromUserResponse) => void): Promise<RevokeShareDeviceFromUserResponse>;
    /**
     ...
     * 创建 TWeSee 回调目标
     */
    CreateTWeSeeCallback(req: CreateTWeSeeCallbackRequest, cb?: (error: string, rep: CreateTWeSeeCallbackResponse) => void): Promise<CreateTWeSeeCallbackResponse>;
    /**
     * 提供查询用户所创建的项目列表查询功能。
     */
     ...
     * 解绑产品或设备上的智能体
     */
    UnbindTWeTalkAgent(req: UnbindTWeTalkAgentRequest, cb?: (error: string, rep: UnbindTWeTalkAgentResponse) => void): Promise<UnbindTWeTalkAgentResponse>;
    /**
     * 为用户提供同步调用设备行为的能力。
     */
     ...
     * 查询指定设备的 TWeSee 人员列表。
     */
    ListTWeSeePersons(req: ListTWeSeePersonsRequest, cb?: (error: string, rep: ListTWeSeePersonsResponse) => void): Promise<ListTWeSeePersonsResponse>;
    /**
     * 创建 TWeSee 语义理解任务
     */
     ...
     */
    DescribeTWeSeePerson(req: DescribeTWeSeePersonRequest, cb?: (error: string, rep: DescribeTWeSeePersonResponse) => void): Promise<DescribeTWeSeePersonResponse>;
    /**
     ...
     * 获取 TWeSee 任务统计数据
     */
    DescribeTWeSeeTaskStatistics(req: DescribeTWeSeeTaskStatisticsRequest, cb?: (error: string, rep: DescribeTWeSeeTaskStatisticsResponse) => void): Promise<DescribeTWeSeeTaskStatisticsResponse>;
    /**
     * 获取围栏绑定信息列表。
     */
     ...
     * 开通 TWeSee 后付费服务
     */
    CreateTWeSeePostPaidService(req: CreateTWeSeePostPaidServiceRequest, cb?: (error: string, rep: CreateTWeSeePostPaidServiceResponse) => void): Promise<CreateTWeSeePostPaidServiceResponse>;
    /**
     * 拉取云存用户列表
     */
     ...
     */
    CreateTWeSeeDirectUploadCredential(req: CreateTWeSeeDirectUploadCredentialRequest, cb?: (error: string, rep: CreateTWeSeeDirectUploadCredentialResponse) => void): Promise<CreateTWeSeeDirectUploadCredentialResponse>;
    /**
...
用于查询视频激活码统计概览
     ...
     * 删除 TWeSee 回调目标
     */
    DeleteTWeSeeCallback(req: DeleteTWeSeeCallbackRequest, cb?: (error: string, rep: DeleteTWeSeeCallbackResponse) => void): Promise<DeleteTWeSeeCallbackResponse>;
    /**
     ...
     */
    CreateDevicePublishSDPAnswer(req: CreateDevicePublishSDPAnswerRequest, cb?: (error: string, rep: CreateDevicePublishSDPAnswerResponse) => void): Promise<CreateDevicePublishSDPAnswerResponse>;
    /**
...
> ⚠️ `method` 必须为 `rrpc_sync_reply`，否则会直接 skip。
     */
    CallDeviceRRPCSync(req: CallDeviceRRPCSyncRequest, cb?: (error: string, rep: CallDeviceRRPCSyncResponse) => void): Promise<CallDeviceRRPCSyncResponse>;
    /**
     ...
     * 开通 TWeSee 预付费订阅
     */
    CreateTWeSeeSubscription(req: CreateTWeSeeSubscriptionRequest, cb?: (error: string, rep: CreateTWeSeeSubscriptionResponse) => void): Promise<CreateTWeSeeSubscriptionResponse>;
    /**
     * 新增TWeTalk智能体。
     */
    CreateTWeTalkAgent(req: CreateTWeTalkAgentRequest, cb?: (error: string, rep: CreateTWeTalkAgentResponse) => void): Promise<CreateTWeTalkAgentResponse>;
    /**
     * 继承云存用户
     */
     ...
     * 分页查询智能体列表
     */
    DescribeTWeTalkAgentList(req: DescribeTWeTalkAgentListRequest, cb?: (error: string, rep: DescribeTWeTalkAgentListResponse) => void): Promise<DescribeTWeTalkAgentListResponse>;
    /**
...
3. 解除设备与该家庭的绑定关系，异步下发 `delete_device` 消息；解绑路径不校验设备存在性，允许设备已删除时清理残留绑定关系。
     */
    RevokeBindUserDevice(req: RevokeBindUserDeviceRequest, cb?: (error: string, rep: RevokeBindUserDeviceResponse) => void): Promise<RevokeBindUserDeviceResponse>;
    /**
     ...
     * 短摘要列表查询
     */
    ListTWeSeeTasks(req: ListTWeSeeTasksRequest, cb?: (error: string, rep: ListTWeSeeTasksResponse) => void): Promise<ListTWeSeeTasksResponse>;
    /**
     * 修改 TWeSee 回调目标
     */
    ModifyTWeSeeCallback(req: ModifyTWeSeeCallbackRequest, cb?: (error: string, rep: ModifyTWeSeeCallbackResponse) => void): Promise<ModifyTWeSeeCallbackResponse>;
    /**
     ...
     * 修改 TWeSee 预付费订阅
     */
    ModifyTWeSeeSubscription(req: ModifyTWeSeeSubscriptionRequest, cb?: (error: string, rep: ModifyTWeSeeSubscriptionResponse) => void): Promise<ModifyTWeSeeSubscriptionResponse>;
    /**
     * 删除围栏绑定信息。
     */
     ...
     */
    ModifyTWeSeePerson(req: ModifyTWeSeePersonRequest, cb?: (error: string, rep: ModifyTWeSeePersonResponse) => void): Promise<ModifyTWeSeePersonResponse>;
    /**
     * 查询固件升级任务的设备列表
     */
     ...
     */
    ModifyTWeSeeFace(req: ModifyTWeSeeFaceRequest, cb?: (error: string, rep: ModifyTWeSeeFaceResponse) => void): Promise<ModifyTWeSeeFaceResponse>;
    /**
     * 用于配置TWeTalk服务连接产品配置信息。
     */
     ...
     * 获取云存时间轴视频列表
     */
    GetVodCloudStorageVideoList(req: GetVodCloudStorageVideoListRequest, cb?: (error: string, rep: GetVodCloudStorageVideoListResponse) => void): Promise<GetVodCloudStorageVideoListResponse>;
    /**
     * 提供给用户异步调用设备行为的能力
     */
     ...
     * 调用 TWeSee 视觉理解算法
     */
    InvokeTWeSeeComprehension(req: InvokeTWeSeeComprehensionRequest, cb?: (error: string, rep: InvokeTWeSeeComprehensionResponse) => void): Promise<InvokeTWeSeeComprehensionResponse>;
    /**
     * 修改LoRa自定义频点
     */
     ...
     * 查询 TWeSee 后付费服务
     */
    DescribeTWeSeePostPaidService(req: DescribeTWeSeePostPaidServiceRequest, cb?: (error: string, rep: DescribeTWeSeePostPaidServiceResponse) => void): Promise<DescribeTWeSeePostPaidServiceResponse>;
    /**
     * 查询 TWeSee 预付费订阅
     */
    DescribeTWeSeeSubscription(req: DescribeTWeSeeSubscriptionRequest, cb?: (error: string, rep: DescribeTWeSeeSubscriptionResponse) => void): Promise<DescribeTWeSeeSubscriptionResponse>;
    /**
     * 用于新增TWeTalk智能体。
     */
...
发布广播消息
     ...
     * 退订 TWeSee 预付费订阅
     */
    TerminateTWeSeeSubscription(req: TerminateTWeSeeSubscriptionRequest, cb?: (error: string, rep: TerminateTWeSeeSubscriptionResponse) => void): Promise<TerminateTWeSeeSubscriptionResponse>;
    /**
     * 提供删除某个项目下产品的能力
     */
     ...
     * 修改TWeTalk智能体
     */
    ModifyTWeTalkAgent(req: ModifyTWeTalkAgentRequest, cb?: (error: string, rep: ModifyTWeTalkAgentResponse) => void): Promise<ModifyTWeTalkAgentResponse>;
    /**
     * TWeTalk消耗账单明细。
     */
     ...
     * 查询实例概览详情。
     */
    DescribeLicenseOverview(req: DescribeLicenseOverviewRequest, cb?: (error: string, rep: DescribeLicenseOverviewResponse) => void): Promise<DescribeLicenseOverviewResponse>;
    /**
     * 创建新 LoRa 网关设备接口
     */
...
3. 将设备直接绑定到该家庭（已绑同家庭视为成功，并继续异步下发 `bind_device` 消息）。
     */
    BindUserDevice(req: BindUserDeviceRequest, cb?: (error: string, rep: BindUserDeviceResponse) => void): Promise<BindUserDeviceResponse>;
    /**
     ...
     * 拉取云存日期
     */
    DescribeVodCloudStorageDate(req: DescribeVodCloudStorageDateRequest, cb?: (error: string, rep: DescribeVodCloudStorageDateResponse) => void): Promise<DescribeVodCloudStorageDateResponse>;
    /**
     * 更新应用信息
     */
     ...
     * 修改 TWeSee 预付费订阅续费标识
     */
    ModifyTWeSeeSubscriptionRenewFlag(req: ModifyTWeSeeSubscriptionRenewFlagRequest, cb?: (error: string, rep: ModifyTWeSeeSubscriptionRenewFlagResponse) => void): Promise<ModifyTWeSeeSubscriptionRenewFlagResponse>;
    /**
     * 查询、删除或列举 TWeSee 直传对象
     */
    OperateTWeSeeDirectUploadObject(req: OperateTWeSeeDirectUploadObjectRequest, cb?: (error: string, rep: OperateTWeSeeDirectUploadObjectResponse) => void): Promise<OperateTWeSeeDirectUploadObjectResponse>;
    /**
     * 批量禁用启用设备
     */
     ...
     */
    DescribeCloudStorageEventsByTWeSeePerson(req: DescribeCloudStorageEventsByTWeSeePersonRequest, cb?: (error: string, rep: DescribeCloudStorageEventsByTWeSeePersonResponse) => void): Promise<DescribeCloudStorageEventsByTWeSeePersonResponse>;
    /**
     * 搜索位置空间
     */
     ...
     * 查询 TWeSee 预付费续费价格
     */
    InquireTWeSeeSubscriptionRenewPrice(req: InquireTWeSeeSubscriptionRenewPriceRequest, cb?: (error: string, rep: InquireTWeSeeSubscriptionRenewPriceResponse) => void): Promise<InquireTWeSeeSubscriptionRenewPriceResponse>;
    /**
     ...
     * 查询 TWeSee 回调目标详情
     */
    DescribeTWeSeeCallback(req: DescribeTWeSeeCallbackRequest, cb?: (error: string, rep: DescribeTWeSeeCallbackResponse) => void): Promise<DescribeTWeSeeCallbackResponse>;
    /**
     * 用于查询TWeTalk服务连接产品配置信息。
     */
     ...
     * 获取云存事件列表
     */
    GetVodCloudStorageEventList(req: GetVodCloudStorageEventListRequest, cb?: (error: string, rep: GetVodCloudStorageEventListResponse) => void): Promise<GetVodCloudStorageEventListResponse>;
    /**
     * 获取产品动态注册详情
     */
     ...
     * 查询 TWeSee 任务详情
     */
    DescribeTWeSeeTask(req: DescribeTWeSeeTaskRequest, cb?: (error: string, rep: DescribeTWeSeeTaskResponse) => void): Promise<DescribeTWeSeeTaskResponse>;
    /**
     * 创建一个 TWeSee 人员，可关联已导入的人脸。
     */
    CreateTWeSeePerson(req: CreateTWeSeePersonRequest, cb?: (error: string, rep: CreateTWeSeePersonResponse) => void): Promise<CreateTWeSeePersonResponse>;
    /**
     ...
     * 销毁 TWeSee 预付费订阅
     */
    DestroyTWeSeeSubscription(req: DestroyTWeSeeSubscriptionRequest, cb?: (error: string, rep: DestroyTWeSeeSubscriptionResponse) => void): Promise<DestroyTWeSeeSubscriptionResponse>;
    /**
     * 查询智能体绑定关系
     */
    DescribeTWeTalkAgentBinding(req: DescribeTWeTalkAgentBindingRequest, cb?: (error: string, rep: DescribeTWeTalkAgentBindingResponse) => void): Promise<DescribeTWeTalkAgentBindingResponse>;
    /**
     * 提供修改产品的数据模板的能力
     */
     ...
     * 批量查询 TWeSee 订单状态
     */
    BatchDescribeTWeSeeOrders(req: BatchDescribeTWeSeeOrdersRequest, cb?: (error: string, rep: BatchDescribeTWeSeeOrdersResponse) => void): Promise<BatchDescribeTWeSeeOrdersResponse>;
    /**
     * 查询设备绑定的网关设备
     */
...
- `BindingScope=device` 时，`DeviceName` 必填。
     */
    BindTWeTalkAgent(req: BindTWeTalkAgentRequest, cb?: (error: string, rep: BindTWeTalkAgentResponse) => void): Promise<BindTWeTalkAgentResponse>;
    /**
     * 拉取多个云存事件缩略图
     */
...
4. 写入分享关系（重复分享幂等成功，不修改原 CreateTime）。
     */
    ShareDeviceToUser(req: ShareDeviceToUserRequest, cb?: (error: string, rep: ShareDeviceToUserResponse) => void): Promise<ShareDeviceToUserResponse>;
    /**
     * 查询云存服务详情
     */
     ...
     * 批量续费 TWeSee 预付费订阅
     */
    BatchRenewTWeSeeSubscription(req: BatchRenewTWeSeeSubscriptionRequest, cb?: (error: string, rep: BatchRenewTWeSeeSubscriptionResponse) => void): Promise<BatchRenewTWeSeeSubscriptionResponse>;
    /**
     * 修改产品动态注册
     */
     ...
     */
    DeleteTWeSeeTasksByCondition(req: DeleteTWeSeeTasksByConditionRequest, cb?: (error: string, rep: DeleteTWeSeeTasksByConditionResponse) => void): Promise<DeleteTWeSeeTasksByConditionResponse>;
    /**
     * 更新围栏。
     */
     ...
     */
    DeleteDeviceSDP(req: DeleteDeviceSDPRequest, cb?: (error: string, rep: DeleteDeviceSDPResponse) => void): Promise<DeleteDeviceSDPResponse>;
    /**
     * 查询指定 TWeSee 人脸详情。
     */
    DescribeTWeSeeFace(req: DescribeTWeSeeFaceRequest, cb?: (error: string, rep: DescribeTWeSeeFaceResponse) => void): Promise<DescribeTWeSeeFaceResponse>;
    /**
     * 同步执行 TWeSee 语义理解任务
     */
     ...
     * 用于删除TWeTalk智能体
     */
    DeleteTWeTalkAgent(req: DeleteTWeTalkAgentRequest, cb?: (error: string, rep: DeleteTWeTalkAgentResponse) => void): Promise<DeleteTWeTalkAgentResponse>;
    /**
     * 用于查询某个产品下的设备列表
     */
     ...
     */
    ImportTWeSeeFaces(req: ImportTWeSeeFacesRequest, cb?: (error: string, rep: ImportTWeSeeFacesResponse) => void): Promise<ImportTWeSeeFacesResponse>;
    /**
     * 用于绑定一个产品和智能体。
     */
     ...
     * 查询 TWeSee 回调目标列表
     */
    ListTWeSeeCallback(req: ListTWeSeeCallbackRequest, cb?: (error: string, rep: ListTWeSeeCallbackResponse) => void): Promise<ListTWeSeeCallbackResponse>;
    /**
     * 搜索规则
     */
     ...
     * 批量开通 TWeSee 预付费订阅
     */
    BatchCreateTWeSeeSubscription(req: BatchCreateTWeSeeSubscriptionRequest, cb?: (error: string, rep: BatchCreateTWeSeeSubscriptionResponse) => void): Promise<BatchCreateTWeSeeSubscriptionResponse>;
    /**
     * 用于获取设备绑定的用户列表
     */
     ...
     * 用户查询TWeTalk智能体详情
     */
    DescribeTWeTalkAgent(req: DescribeTWeTalkAgentRequest, cb?: (error: string, rep: DescribeTWeTalkAgentResponse) => void): Promise<DescribeTWeTalkAgentResponse>;
    /**
     * 拉取 TWeSee 配置
     */
     ...
     * 删除指定 TWeSee 人脸。
     */
    DeleteTWeSeeFace(req: DeleteTWeSeeFaceRequest, cb?: (error: string, rep: DeleteTWeSeeFaceResponse) => void): Promise<DeleteTWeSeeFaceResponse>;
    /**
     * 查询 TWeSee 语义理解任务
     */
