...
export declare class Client extends AbstractClient {
     ...
     * 修改集群级别
     */
    ModifyClusterLevel(req: ModifyClusterLevelRequest, cb?: (error: string, rep: ModifyClusterLevelResponse) => void): Promise<ModifyClusterLevelResponse>;
    /**
     ...
     */
    DescribeClusterStorageAutoExpand(req: DescribeClusterStorageAutoExpandRequest, cb?: (error: string, rep: DescribeClusterStorageAutoExpandResponse) => void): Promise<DescribeClusterStorageAutoExpandResponse>;
    /**
