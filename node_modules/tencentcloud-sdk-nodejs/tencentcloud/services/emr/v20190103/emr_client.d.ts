...
- 接口为异步接口，接口返回时操作并未立即完成，实例操作结果可以通过调用DescribeInstancesList查看当前实例的StatusDesc状态。
     ...
     * 配置导入下发
     */
    ModifyServiceParamsByExportConfs(req: ModifyServiceParamsByExportConfsRequest, cb?: (error: string, rep: ModifyServiceParamsByExportConfsResponse) => void): Promise<ModifyServiceParamsByExportConfsResponse>;
    /**
...
批量导出用户。对于kerberos集群，如果需要kertab文件下载地址，可以将NeedKeytabInfo设置为true；注意SupportDownLoadKeyTab为true，但是DownLoadKeyTabUrl为空字符串，表示keytab文件在后台没有准备好（正在生成）。
     ...
     * 集群metadb数据
     */
    DescribeMetaDBInfo(req: DescribeMetaDBInfoRequest, cb?: (error: string, rep: DescribeMetaDBInfoResponse) => void): Promise<DescribeMetaDBInfoResponse>;
    /**
     * 查询集群实例信息
     */
...
修改YARN资源调度的资源配置。已废弃，请使用`ModifyYarnQueueV2`来修改队列配置
     ...
     * 查询导出配置
     */
    DescribeExportConfs(req: DescribeExportConfsRequest, cb?: (error: string, rep: DescribeExportConfsResponse) => void): Promise<DescribeExportConfsResponse>;
    /**
     * 批量删除用户组
     */
