...
import { CreateDBInstancesRequest, ModifyDBInstanceVPortRequest, ExpandInstanceResponse, DescribeStandbyDBInstanceRelationDetailResponse, DescribeDatabasesRequest, DescribeDBParametersRequest, ModifyInstanceNetworkResponse, ModifyInstanceSSLStatusResponse, DescribeDBEnginesRequest, RestartDBInstancesResponse, DescribeSlowLogsRequest, ModifyInstanceNameRequest, DescribeUserPrivilegesResponse, DescribeDBSecurityGroupsResponse, DescribeInstanceDataReservedSpaceRequest, ResetUsersPasswordRequest, ModifyInstanceDataReservedSpaceResponse, ModifyInstanceSSLStatusRequest, ResetDbaAdminPrivilegesResponse, ModifyInstanceNameResponse, DescribeDBSBackupStatisticsDetailRequest, DescribeDBParametersResponse, DescribeDBCharsetsResponse, IsolateDBInstanceResponse, DescribeInstanceSSLStatusResponse, DeleteDBSBackupSetsResponse, DescribeFlowResponse, DescribeStandbyDBInstanceRelationDetailRequest, DescribeDBSBackupStatisticsDetailResponse, ModifyDBSBackupSetCommentRequest, DescribeDBSBackupPolicyResponse, DeleteDBSBackupSetsRequest, DescribeSpecsResponse, ModifyDBInstanceSecurityGroupsResponse, DescribeDBSArchiveLogsResponse, ModifyUserPrivilegesResponse, DescribeFlowTypesResponse, DescribeSlowLogsResponse, CreateDBSBackupResponse, DescribeDBSBackupSetsResponse, DescribeDBSCloneInstancesRequest, CreateCloneInstanceRequest, DescribeDBInstancesRequest, DescribeDBSecurityGroupsRequest, DescribeSaleInfoRequest, DescribeDBSArchiveLogsRequest, CreateUsersResponse, ModifyDBSBackupPolicyRequest, DescribeDBInstanceDetailResponse, DescribeDatabaseObjectsRequest, ModifyMaintenanceWindowRequest, ModifyInstanceDataReservedSpaceRequest, DestroyInstancesResponse, DescribeSaleInfoResponse, DeleteUsersResponse, DescribeDBInstanceDetailRequest, ModifyAutoRenewFlagResponse, CancelIsolateDBInstancesResponse, ModifyDBSBackupPolicyResponse, CreateUsersRequest, ModifyDBParametersRequest, ModifyDBParametersResponse, DescribeInstanceSSLStatusRequest, DeleteUsersRequest, ModifyUserPrivilegesRequest, CreateCloneInstanceResponse, DescribeDatabaseObjectsResponse, DescribeMaintenanceWindowResponse, DescribeFlowTypesRequest, DescribeDBCharsetsRequest, DescribeDBSBackupStatisticsResponse, DescribeDBSCloneInstancesResponse, DescribeDBSBackupSetsRequest, DescribeDBSBackupStatisticsRequest, DescribeUsersResponse, DescribeUsersRequest, DescribeDBSBackupPolicyRequest, UpgradeInstanceResponse, CancelIsolateDBInstancesRequest, ExpandInstanceRequest, DescribeDatabasesResponse, ModifyMaintenanceWindowResponse, IsolateDBInstanceRequest, DescribeFlowRequest, ModifyDBSBackupSetCommentResponse, DescribeDBEnginesResponse, ModifyAutoRenewFlagRequest, ResetUsersPasswordResponse, CreateDBSBackupRequest, DestroyInstancesRequest, DescribeMaintenanceWindowRequest, DescribeSpecsRequest, CreateStandbyDBInstanceResponse, ModifyInstanceNetworkRequest, DescribeDBInstancesResponse, BreakStandbyDBInstanceRelationRequest, CreateStandbyDBInstanceRequest, RestartDBInstancesRequest, DescribeDBSAvailableRecoveryTimeResponse, DescribeUserPrivilegesRequest, DescribeDBSAvailableRecoveryTimeRequest, ModifyDBInstanceVPortResponse, ResetDbaAdminPrivilegesRequest, BreakStandbyDBInstanceRelationResponse, DescribeInstanceDataReservedSpaceResponse, UpgradeInstanceRequest, CreateDBInstancesResponse, ModifyDBInstanceSecurityGroupsRequest } from "./tdmysql_models";
/**
 * tdmysql client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    ResetUsersPassword(req: ResetUsersPasswordRequest, cb?: (error: string, rep: ResetUsersPasswordResponse) => void): Promise<ResetUsersPasswordResponse>;
    /**
     * 查询实例备份策略 DescribeDBSBackupPolicy
     */
    DescribeDBSBackupPolicy(req: DescribeDBSBackupPolicyRequest, cb?: (error: string, rep: DescribeDBSBackupPolicyResponse) => void): Promise<DescribeDBSBackupPolicyResponse>;
    /**
     * 本接口（ModifyInstanceSSLStatus）提供开关实例SSL的功能
     */
    ModifyInstanceSSLStatus(req: ModifyInstanceSSLStatusRequest, cb?: (error: string, rep: ModifyInstanceSSLStatusResponse) => void): Promise<ModifyInstanceSSLStatusResponse>;
    /**
     ...
     */
    BreakStandbyDBInstanceRelation(req: BreakStandbyDBInstanceRelationRequest, cb?: (error: string, rep: BreakStandbyDBInstanceRelationResponse) => void): Promise<BreakStandbyDBInstanceRelationResponse>;
    /**
     ...
     */
    DescribeDBEngines(req?: DescribeDBEnginesRequest, cb?: (error: string, rep: DescribeDBEnginesResponse) => void): Promise<DescribeDBEnginesResponse>;
    /**
     ...
     */
    ModifyDBInstanceVPort(req: ModifyDBInstanceVPortRequest, cb?: (error: string, rep: ModifyDBInstanceVPortResponse) => void): Promise<ModifyDBInstanceVPortResponse>;
    /**
     ...
     */
    DescribeInstanceDataReservedSpace(req: DescribeInstanceDataReservedSpaceRequest, cb?: (error: string, rep: DescribeInstanceDataReservedSpaceResponse) => void): Promise<DescribeInstanceDataReservedSpaceResponse>;
    /**
     * 本接口（ModifyInstanceDataReservedSpace）提供修改实例数据保留空间
     */
    ModifyInstanceDataReservedSpace(req: ModifyInstanceDataReservedSpaceRequest, cb?: (error: string, rep: ModifyInstanceDataReservedSpaceResponse) => void): Promise<ModifyInstanceDataReservedSpaceResponse>;
    /**
     * 重置dbaadmin账号权限
     */
    ResetDbaAdminPrivileges(req: ResetDbaAdminPrivilegesRequest, cb?: (error: string, rep: ResetDbaAdminPrivilegesResponse) => void): Promise<ResetDbaAdminPrivilegesResponse>;
    /**
     ...
     */
    ModifyUserPrivileges(req: ModifyUserPrivilegesRequest, cb?: (error: string, rep: ModifyUserPrivilegesResponse) => void): Promise<ModifyUserPrivilegesResponse>;
    /**
     * 查询实例备份集信息 DescribeDBSBackupSets
     */
    DescribeDBSBackupSets(req: DescribeDBSBackupSetsRequest, cb?: (error: string, rep: DescribeDBSBackupSetsResponse) => void): Promise<DescribeDBSBackupSetsResponse>;
    /**
     ...
     */
    DescribeDBSBackupStatistics(req: DescribeDBSBackupStatisticsRequest, cb?: (error: string, rep: DescribeDBSBackupStatisticsResponse) => void): Promise<DescribeDBSBackupStatisticsResponse>;
    /**
     * 本接口提供查询慢日志功能
     */
     ...
     */
    DescribeInstanceSSLStatus(req: DescribeInstanceSSLStatusRequest, cb?: (error: string, rep: DescribeInstanceSSLStatusResponse) => void): Promise<DescribeInstanceSSLStatusResponse>;
    /**
     ...
     */
    CreateStandbyDBInstance(req: CreateStandbyDBInstanceRequest, cb?: (error: string, rep: CreateStandbyDBInstanceResponse) => void): Promise<CreateStandbyDBInstanceResponse>;
    /**
     * 本接口（DescribeUserPrivileges）提供查询用户的权限功能
     */
    DescribeUserPrivileges(req: DescribeUserPrivilegesRequest, cb?: (error: string, rep: DescribeUserPrivilegesResponse) => void): Promise<DescribeUserPrivilegesResponse>;
    /**
     * 本接口（CreateUsers）用于批量创建用户
     */
    CreateUsers(req: CreateUsersRequest, cb?: (error: string, rep: CreateUsersResponse) => void): Promise<CreateUsersResponse>;
    /**
     ...
     */
    DescribeSpecs(req: DescribeSpecsRequest, cb?: (error: string, rep: DescribeSpecsResponse) => void): Promise<DescribeSpecsResponse>;
    /**
     * 查询备份集统计详情 DescribeDBSBackupStatisticsDetail
     */
    DescribeDBSBackupStatisticsDetail(req: DescribeDBSBackupStatisticsDetailRequest, cb?: (error: string, rep: DescribeDBSBackupStatisticsDetailResponse) => void): Promise<DescribeDBSBackupStatisticsDetailResponse>;
    /**
     ...
     */
    DescribeStandbyDBInstanceRelationDetail(req: DescribeStandbyDBInstanceRelationDetailRequest, cb?: (error: string, rep: DescribeStandbyDBInstanceRelationDetailResponse) => void): Promise<DescribeStandbyDBInstanceRelationDetailResponse>;
    /**
     ...
     */
    ExpandInstance(req: ExpandInstanceRequest, cb?: (error: string, rep: ExpandInstanceResponse) => void): Promise<ExpandInstanceResponse>;
    /**
     * 查询维护时间窗口配置
     */
     ...
     */
    DescribeFlowTypes(req?: DescribeFlowTypesRequest, cb?: (error: string, rep: DescribeFlowTypesResponse) => void): Promise<DescribeFlowTypesResponse>;
    /**
