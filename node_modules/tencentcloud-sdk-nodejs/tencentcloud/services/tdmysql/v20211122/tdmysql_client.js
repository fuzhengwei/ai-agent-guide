...
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    async DescribeDBEngines(req, cb) {
     ...
     */
    async ModifyDBInstanceVPort(req, cb) {
     ...
     */
    async DescribeDBSBackupStatistics(req, cb) {
     ...
     */
    async DescribeInstanceSSLStatus(req, cb) {
     ...
     */
    async DescribeStandbyDBInstanceRelationDetail(req, cb) {
