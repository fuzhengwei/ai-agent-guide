...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeTopSpaceTablesV2(req: DescribeTopSpaceTablesV2Request, cb?: (error: string, rep: DescribeTopSpaceTablesV2Response) => void): Promise<DescribeTopSpaceTablesV2Response>;
    /**
     * 查询实例SQL限流任务列表。
     */
