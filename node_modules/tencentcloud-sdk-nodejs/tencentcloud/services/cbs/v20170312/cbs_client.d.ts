...
* 如果快照组内的快照有关联镜像，则删除失败，所有快照均不会删除；如果需要同时删除快照绑定的镜像，可传入参数DeleteBindImages等于true。
     ...
     * 查询云服务器独享集群云硬盘统计信息。
     */
    DescribeDedicatedClusterDiskStatistics(req: DescribeDedicatedClusterDiskStatisticsRequest, cb?: (error: string, rep: DescribeDedicatedClusterDiskStatisticsResponse) => void): Promise<DescribeDedicatedClusterDiskStatisticsResponse>;
    /**
