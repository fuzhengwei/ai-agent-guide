...
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    async CreatePrivateNetworkInstance(req, cb) {
     ...
     * 开通边缘节点计费服务。
     */
    async CreateEdgeNodeService(req, cb) {
     ...
     */
    async DescribePublicIps(req, cb) {
        return this.request("DescribePublicIps", req, cb);
    }
    /**
     * 删除私网实例
     */
    async DeletePrivateNetworkInstance(req, cb) {
...
此接口仅适用于 `RouteMode=static` 的公网实例。BGP/OSPF 实例调用此接口将返回错误。
     */
    async ApplyPublicIps(req, cb) {
        return this.request("ApplyPublicIps", req, cb);
    }
    /**
     * 修改私网实例信息
     */
    async ModifyPrivateNetworkInstance(req, cb) {
...
路由模式为 **OSPF、BGP** 的公网实例在创建时自动分配公网IP段，销毁时自动释放公网IP段
     */
    async CreatePublicNetworkInstance(req, cb) {
