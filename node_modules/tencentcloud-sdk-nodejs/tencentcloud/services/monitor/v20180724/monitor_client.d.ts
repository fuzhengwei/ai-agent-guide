...
| /alertmanager/api/v2/silence/{id} | GET | 告警静默详情查询 |
     ...
     * 创建小程序告警屏蔽规则
     */
    CreateAlarmHistoryShield(req: CreateAlarmHistoryShieldRequest, cb?: (error: string, rep: CreateAlarmHistoryShieldResponse) => void): Promise<CreateAlarmHistoryShieldResponse>;
    /**
     * 修改告警接收人
     */
     ...
     * 列出 Grafana 版本
     */
    DescribeGrafanaVersions(req?: DescribeGrafanaVersionsRequest, cb?: (error: string, rep: DescribeGrafanaVersionsResponse) => void): Promise<DescribeGrafanaVersionsResponse>;
    /**
     * 编辑告警通知模板
     */
...
同一项目下相同的告警策略类型，就会被设置为非默认。
     ...
     * 获取小程序告警屏蔽规则
     */
    DescribeAlarmHistoryShield(req: DescribeAlarmHistoryShieldRequest, cb?: (error: string, rep: DescribeAlarmHistoryShieldResponse) => void): Promise<DescribeAlarmHistoryShieldResponse>;
    /**
     ...
     */
    ModifyPrometheusInstanceAccessPoints(req?: ModifyPrometheusInstanceAccessPointsRequest, cb?: (error: string, rep: ModifyPrometheusInstanceAccessPointsResponse) => void): Promise<ModifyPrometheusInstanceAccessPointsResponse>;
    /**
     ...
     * 修改小程序告警屏蔽规则
     */
    ModifyAlarmHistoryShield(req: ModifyAlarmHistoryShieldRequest, cb?: (error: string, rep: ModifyAlarmHistoryShieldResponse) => void): Promise<ModifyAlarmHistoryShieldResponse>;
    /**
     * 获取基础告警列表
     */
...
<li>如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的实例。</li>
     ...
     * 删除小程序告警屏蔽规则
     */
    DeleteAlarmHistoryShields(req: DeleteAlarmHistoryShieldsRequest, cb?: (error: string, rep: DeleteAlarmHistoryShieldsResponse) => void): Promise<DeleteAlarmHistoryShieldsResponse>;
    /**
     * 获取2.0实例告警策略列表
     */
