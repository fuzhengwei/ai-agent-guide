...
提交工作流。本接口已废弃，请使用接口BatchCreateTaskVersionAsync。
     ...
     * 解绑bundle绑定的资源
     */
    UnbindingResource(req: UnbindingResourceRequest, cb?: (error: string, rep: UnbindingResourceResponse) => void): Promise<UnbindingResourceResponse>;
    /**
     * 离线任务实例运行日志列表
     */
