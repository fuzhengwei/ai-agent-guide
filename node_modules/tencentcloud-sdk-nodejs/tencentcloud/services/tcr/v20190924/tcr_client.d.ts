...
注意：当PolicyIndex和CidrBlock同时存在时，CidrBlock优先级更高
     ...
     * 实例同步/实例复制策略执行记录列表
     */
    DescribeReplicationExecutions(req: DescribeReplicationExecutionsRequest, cb?: (error: string, rep: DescribeReplicationExecutionsResponse) => void): Promise<DescribeReplicationExecutionsResponse>;
    /**
     * 更新实例内指定长期访问凭证的启用状态
     */
     ...
     * 实例同步/实例复制执行任务列表
     */
    DescribeReplicationTasks(req: DescribeReplicationTasksRequest, cb?: (error: string, rep: DescribeReplicationTasksResponse) => void): Promise<DescribeReplicationTasksResponse>;
    /**
     * 用于在个人版仓库中创建镜像仓库
     */
