...
import { StopInstanceRequest, DescribeServicesCallInfoResponse, TerminateInstancesResponse, ResizeInstanceDiskRequest, DescribeDeployTemplatesResponse, DescribeScenesResponse, RunInstancesRequest, DescribeInstancesResponse, DescribeRegionsResponse, DeleteServiceRequest, StartInstanceResponse, DescribeInstanceNetworkStatusResponse, DescribeApplicationsResponse, DescribeServiceLoginSettingsResponse, StartInstanceRequest, DeployInferServiceResponse, DescribeMuskPromptsResponse, UpdateServiceConfigsResponse, RunInstancesResponse, DescribeServicesCallInfoRequest, StopInstanceResponse, DeployInferServiceRequest, CreateInferServiceByTemplateRequest, DescribeRegionsRequest, DescribeServicesRequest, DescribeInstanceNetworkStatusRequest, InquirePriceRunInstancesRequest, GetServicePodLogsResponse, DeleteServiceResponse, InquirePriceUpdateServiceConfigsRequest, CreateInferServiceByTemplateResponse, CreateMuskPromptResponse, ResetInstancesPasswordRequest, ResetInstancesPasswordResponse, DescribeServiceLoginSettingsRequest, DescribeDeployTemplatesRequest, ResizeInstanceDiskResponse, InquirePriceUpdateServiceConfigsResponse, DescribeModelsRequest, CreateMuskPromptRequest, GetServicePodLogsRequest, InquirePriceRunInstancesResponse, TerminateInstancesRequest, DescribeServicesResponse, DescribeMuskPromptsRequest, DescribeInstancesRequest, DescribeApplicationsRequest, CreateApplicationRequest, UpdateServiceConfigsRequest, DescribeScenesRequest, CreateApplicationResponse, DescribeModelsResponse } from "./hai_models";
/**
 * hai client
 * @class
 */
...
‘运行中’、‘预付费’的实例不支持启动实例
     ...
     */
    GetServicePodLogs(req?: GetServicePodLogsRequest, cb?: (error: string, rep: GetServicePodLogsResponse) => void): Promise<GetServicePodLogsResponse>;
    /**
