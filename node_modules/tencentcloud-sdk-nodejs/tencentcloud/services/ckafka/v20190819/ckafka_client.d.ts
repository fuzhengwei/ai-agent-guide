...
import { DescribeACLRequest, DescribeTopicSyncReplicaResponse, FetchMessageByOffsetRequest, AuthorizeTokenResponse, DescribeAclRuleResponse, CancelAuthorizationTokenRequest, DeleteTopicRequest, FetchMessageListByOffsetRequest, CreateAclRuleRequest, DescribeInstancesDetailResponse, DescribeTaskStatusRequest, DescribeAclRuleRequest, RestartDatahubTaskRequest, ModifyAclRuleResponse, CreateMetaDataAndOffsetSyncDatahubTaskRequest, FetchMessageListByOffsetResponse, DeleteRouteTriggerTimeRequest, CreatePostPaidInstanceRequest, AuthorizeTokenRequest, RenewCkafkaInstanceResponse, CreatePartitionResponse, DescribeTopicResponse, CreateTopicIpWhiteListResponse, CreateTopicRequest, DeleteAclResponse, DescribeDatahubGroupOffsetsResponse, DeleteConnectResourceResponse, RestartDatahubTaskResponse, CreateMetaAndDataSyncDatahubTaskRequest, DescribeTopicRequest, IsolatedInstancePreRequest, ModifyAclRuleRequest, ModifyRoutineMaintenanceTaskRequest, DescribeInstanceAttributesResponse, DisassociateRoutesSecurityGroupRequest, CreateTopicResponse, UpgradeBrokerVersionResponse, DescribeConsumerGroupResponse, DescribeDatahubTopicsResponse, BatchCreateAclResponse, ModifyAccessPolicyResponse, DeleteRouteRequest, DescribeGroupInfoResponse, DescribeTopicDetailRequest, DescribeGroupOffsetsResponse, DeleteGroupResponse, CreateTokenResponse, DescribeGroupOffsetsRequest, DescribeTopicDetailResponse, DeleteAclRequest, DeleteThrottleRuleRequest, DescribeDatahubTaskResponse, FetchLatestDatahubMessageListRequest, PauseDatahubTaskResponse, CreateConnectResourceResponse, DescribeAccessPolicyRequest, DescribeDatahubTasksResponse, FetchMessageByOffsetResponse, DescribeSecurityGroupRoutesResponse, DescribeACLResponse, CreateMetaDataAndOffsetSyncDatahubTaskResponse, InquireCkafkaPriceRequest, DescribeCkafkaZoneRequest, FetchMessageListByTimestampRequest, DeleteConnectResourceRequest, DescribeTopicAttributesResponse, CreateConsumerResponse, DescribeGroupResponse, DeleteUserResponse, CreateAclRequest, CreateConnectResourceRequest, ModifyRouteSecurityGroupsResponse, ModifyInstanceAttributesResponse, CreateMetaSyncDatahubTaskRequest, DescribeRegionRequest, CreateThrottleRuleRequest, ModifyRouteSecurityGroupsRequest, ModifyAccessPolicyRequest, ModifyInstanceAttributesRequest, CreateAclRuleResponse, FetchDatahubMessageByOffsetResponse, DeleteDatahubTaskRequest, ModifyConnectResourceResponse, DescribeGroupRequest, InstanceScalingDownRequest, CreateCdcClusterRequest, DescribeInstancesDetailRequest, CreateConsumerRequest, CreateDatahubTopicResponse, FetchDatahubMessageByOffsetRequest, DescribeDatahubGroupOffsetsRequest, BatchModifyGroupOffsetsRequest, AssociateRoutesSecurityGroupRequest, ModifyInstancePreRequest, DescribeTypeInstancesRequest, SendMessageRequest, BatchModifyTopicAttributesRequest, DescribePrometheusRequest, FetchMessageListByTimestampResponse, DeleteInstancePostResponse, ModifyDatahubTopicRequest, CreateMetaAndDataSyncDatahubTaskResponse, ModifyDatahubTaskResponse, DescribeConnectResourcesResponse, DescribeCkafkaVersionResponse, DeleteUserRequest, DescribeTopicAttributesRequest, DescribeDatahubTaskRequest, FetchLatestDatahubMessageListResponse, DescribeInstancesResponse, BatchModifyTopicAttributesResponse, UpgradeBrokerVersionRequest, DescribeTopicSubscribeGroupResponse, DeleteAclRuleRequest, DescribeTypeInstancesResponse, ModifyConnectResourceRequest, CreateTokenRequest, DescribeCvmInfoRequest, DescribeTaskStatusResponse, DescribeModifyTypeRequest, CreateUserResponse, DeleteInstancePostRequest, DescribeTopicProduceConnectionRequest, CreateMetaSyncDatahubTaskResponse, DescribeTopicSubscribeGroupRequest, DeleteGroupSubscribeTopicRequest, DeleteAclRuleResponse, DescribeGroupInfoRequest, DescribeDatahubTopicsRequest, DescribeUserResponse, DescribeThrottleRulesResponse, DeleteInstancePreRequest, PauseDatahubTaskRequest, DescribeInstancesRequest, DescribeCkafkaZoneResponse, ModifyInstancePreResponse, CreateUserRequest, CreateInstancePreResponse, CheckCdcClusterRequest, InstanceScalingDownResponse, DescribeRouteRequest, CreatePostPaidInstanceResponse, DescribeAccessPolicyResponse, DescribeRouteResponse, ModifyDatahubTopicResponse, CreateTopicIpWhiteListRequest, ResumeDatahubTaskResponse, ModifyTopicAttributesRequest, CreateInstancePreRequest, DeleteTopicResponse, BatchCreateAclRequest, ResumeDatahubTaskRequest, DescribeConnectResourcesRequest, CreatePartitionRequest, DescribeInstanceAttributesRequest, CancelAuthorizationTokenResponse, CreateRouteRequest, DescribePrometheusResponse, CheckCdcClusterResponse, DescribeDatahubTasksRequest, DescribeTopicFlowRankingRequest, BatchModifyGroupOffsetsResponse, CreateDatahubTopicRequest, IsolatedInstancePreResponse, DescribeDatahubTopicResponse, DescribeThrottleRulesRequest, CreateCdcClusterResponse, DeleteGroupRequest, CreateThrottleRuleResponse, ModifyThrottleRuleResponse, DescribeConnectResourceRequest, DeleteRouteResponse, CreatePrometheusResponse, ModifyGroupOffsetsResponse, CreateAclResponse, DisassociateRoutesSecurityGroupResponse, ModifyThrottleRuleRequest, DeleteInstancePreResponse, AssociateRoutesSecurityGroupResponse, DescribeCvmInfoResponse, DescribeRegionResponse, DeleteRouteTriggerTimeResponse, DescribeUserRequest, DescribeModifyTypeResponse, DescribeDatahubTopicRequest, ModifyPasswordRequest, DeleteDatahubTopicRequest, ModifyTopicAttributesResponse, DescribeConsumerGroupRequest, DescribeTopicProduceConnectionResponse, DeleteDatahubTopicResponse, SendMessageResponse, ModifyRoutineMaintenanceTaskResponse, DescribeConnectResourceResponse, DescribeSecurityGroupRoutesRequest, ModifyPasswordResponse, DeleteGroupSubscribeTopicResponse, InquireCkafkaPriceResponse, CreateRouteResponse, DeleteThrottleRuleResponse, DeleteDatahubTaskResponse, DescribeTopicFlowRankingResponse, CreateDatahubTaskRequest, ModifyGroupOffsetsRequest, RenewCkafkaInstanceRequest, CreateDatahubTaskResponse, DescribeTopicSyncReplicaRequest, ModifyDatahubTaskRequest, CreatePrometheusRequest, DescribeCkafkaVersionRequest } from "./ckafka_models";
/**
 * ckafka client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 连接器实例同步任务-元数据同步
     */
    CreateMetaSyncDatahubTask(req: CreateMetaSyncDatahubTaskRequest, cb?: (error: string, rep: CreateMetaSyncDatahubTaskResponse) => void): Promise<CreateMetaSyncDatahubTaskResponse>;
    /**
     ...
     */
    CreateMetaDataAndOffsetSyncDatahubTask(req: CreateMetaDataAndOffsetSyncDatahubTaskRequest, cb?: (error: string, rep: CreateMetaDataAndOffsetSyncDatahubTaskResponse) => void): Promise<CreateMetaDataAndOffsetSyncDatahubTaskResponse>;
    /**
     * 连接器实例同步任务-元数据、消息同步
     */
    CreateMetaAndDataSyncDatahubTask(req: CreateMetaAndDataSyncDatahubTaskRequest, cb?: (error: string, rep: CreateMetaAndDataSyncDatahubTaskResponse) => void): Promise<CreateMetaAndDataSyncDatahubTaskResponse>;
    /**
     * 按量实例缩容
     */
     ...
     * 修改路由安全组关联
     */
    ModifyRouteSecurityGroups(req: ModifyRouteSecurityGroupsRequest, cb?: (error: string, rep: ModifyRouteSecurityGroupsResponse) => void): Promise<ModifyRouteSecurityGroupsResponse>;
    /**
     * 查询ACL规则列表
     */
     ...
     * 实例限流规则相关接口
     */
    CreateThrottleRule(req: CreateThrottleRuleRequest, cb?: (error: string, rep: CreateThrottleRuleResponse) => void): Promise<CreateThrottleRuleResponse>;
    /**
     * broker版本升级
     */
     ...
     * 绑定路由安全组
     */
    AssociateRoutesSecurityGroup(req: AssociateRoutesSecurityGroupRequest, cb?: (error: string, rep: AssociateRoutesSecurityGroupResponse) => void): Promise<AssociateRoutesSecurityGroupResponse>;
    /**
     * 修改DIP主题属性
     */
     ...
     * 删除实例限流规则
     */
    DeleteThrottleRule(req: DeleteThrottleRuleRequest, cb?: (error: string, rep: DeleteThrottleRuleResponse) => void): Promise<DeleteThrottleRuleResponse>;
    /**
     * 获取Topic 副本详情信息
     */
     ...
     * 解绑路由安全组
     */
    DisassociateRoutesSecurityGroup(req: DisassociateRoutesSecurityGroupRequest, cb?: (error: string, rep: DisassociateRoutesSecurityGroupResponse) => void): Promise<DisassociateRoutesSecurityGroupResponse>;
    /**
     * 获取DIP主题属性
     */
     ...
     * 获取实例限流规则列表
     */
    DescribeThrottleRules(req: DescribeThrottleRulesRequest, cb?: (error: string, rep: DescribeThrottleRulesResponse) => void): Promise<DescribeThrottleRulesResponse>;
    /**
     * 删除用户
     */
...
本接口（DescribeTopic）用于在用户获取消息队列 CKafka 实例的主题列表
     ...
     */
    IsolatedInstancePre(req: IsolatedInstancePreRequest, cb?: (error: string, rep: IsolatedInstancePreResponse) => void): Promise<IsolatedInstancePreResponse>;
    /**
     * 查询连接器连接列表
     */
     ...
     * 修改限流规则接口
     */
    ModifyThrottleRule(req: ModifyThrottleRuleRequest, cb?: (error: string, rep: ModifyThrottleRuleResponse) => void): Promise<ModifyThrottleRuleResponse>;
    /**
     * 查询实例公网IP白名单列表接口
     */
