...
import { SubmitDrawPortraitJobResponse, RefineImageRequest, SubmitMemeJobResponse, QueryMemeJobRequest, QueryTextToImageProJobResponse, UploadTrainPortraitImagesRequest, QueryTrainPortraitModelJobRequest, QueryGlamPicJobResponse, ImageOutpaintingRequest, ReplaceBackgroundResponse, QueryMemeJobResponse, QueryDrawPortraitJobResponse, QueryTrainPortraitModelJobResponse, ChangeClothesResponse, SubmitGlamPicJobResponse, SubmitTextToImageProJobResponse, SubmitTrainPortraitModelJobRequest, SketchToImageRequest, SubmitGlamPicJobRequest, GenerateAvatarRequest, ImageInpaintingRemovalResponse, ReplaceBackgroundRequest, SubmitTextToImageProJobRequest, SubmitTrainPortraitModelJobResponse, QueryDrawPortraitJobRequest, SubmitMemeJobRequest, SketchToImageResponse, QueryGlamPicJobRequest, ImageInpaintingRemovalRequest, ChangeClothesRequest, ImageOutpaintingResponse, UploadTrainPortraitImagesResponse, QueryTextToImageProJobRequest, GenerateAvatarResponse, RefineImageResponse, SubmitDrawPortraitJobRequest } from "./aiart_models";
/**
 * aiart client
 * @class
 */
