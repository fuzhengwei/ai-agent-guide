...
import { DescribeAsyncTextToSpeechRequest, ModifyCloudSliceTaskResponse, DescribeCloudModerationResponse, StartStreamIngestResponse, CreatePictureRequest, DeleteRecognizeVocabV3Request, GetRecognizeVocabListV3Response, DescribeTRTCRealTimeScaleDataRequest, StartAIConversationResponse, DescribeTRTCMarketScaleDataRequest, VoiceCloneRequest, DescribeUserEventRequest, DeleteCloudModerationRequest, CreateLiveStreamModerationRequest, CreateCloudSliceTaskRequest, AsyncTextToSpeechRequest, DescribeTrtcRoomUsageResponse, RegisterVoicePrintRequest, DeleteCloudSliceTaskRequest, ControlAIConversationResponse, StopAIConversationRequest, UpdateAIConversationResponse, DescribeUserEventResponse, DeleteRecognizeVocabV3Response, StopMCUMixTranscodeByStrRoomIdResponse, DescribeCallDetailInfoRequest, CreateCloudModerationResponse, DescribeTRTCSegmentModerationUsageRequest, DescribeTRTCMarketScaleDataResponse, RegisterVoicePrintResponse, ModifyPictureRequest, DescribeWebRecordResponse, DescribeCloudTranscriptionResponse, DescribeUserInfoRequest, DeleteCloudModerationResponse, DescribeRelayUsageRequest, DismissRoomResponse, DescribeRecordStatisticResponse, DescribeLiveStreamModerationResponse, DeleteVoicePrintRequest, DescribeAsyncTextToSpeechResponse, DescribeTrtcUsageResponse, StopAITranscriptionRequest, SetVocabStateV3Response, CreateCloudRecordingResponse, RemoveUserRequest, DescribeWebRecordRequest, CreateRecognizeVocabV3Request, DescribeRecordStatisticRequest, DescribeRoomInfoRequest, DescribeTRTCMarketScaleMetricDataResponse, DescribeCallDetailInfoResponse, DescribeTRTCRealTimeQualityDataResponse, DescribeTRTCAIRecognitionUsageResponse, DescribeMixTranscodingUsageRequest, DescribeTRTCRealTimeQualityDataRequest, DescribeStreamIngestResponse, CreateCloudTranscriptionResponse, DescribeTRTCMarketQualityDataResponse, DescribeVoicePrintResponse, DescribeTrtcUsageRequest, DescribeRoomInfoResponse, StartWebRecordRequest, DescribeAITranscriptionRequest, DescribeAIConversationResponse, DeleteCloudTranscriptionResponse, DescribeUserInfoResponse, GetRecognizeVocabV3Response, RemoveUserByStrRoomIdResponse, DescribeVoicePrintRequest, UpdateStreamIngestResponse, StartMCUMixTranscodeRequest, StartPublishCdnStreamResponse, DeleteLiveStreamModerationResponse, StartMCUMixTranscodeByStrRoomIdResponse, DeleteCloudSliceTaskResponse, DescribeTRTCMarketScaleMetricDataRequest, DescribeRelayUsageResponse, StartStreamIngestRequest, TextToSpeechSSEResponse, DescribeRecordingUsageResponse, DescribeRecordingUsageRequest, ModifyPictureResponse, DescribeScaleInfoResponse, ModifyCloudSliceTaskRequest, StopMCUMixTranscodeResponse, CreateAudioModerationSyncResponse, DescribeMixTranscodingUsageResponse, DismissRoomRequest, DeleteLiveStreamModerationRequest, DescribeUnusualEventRequest, GetRecognizeVocabV3Request, DescribeCloudRecordingRequest, DeleteVoicePrintResponse, StartWebRecordResponse, CreateAudioModerationSyncRequest, DescribeCloudRecordingResponse, ModifyCloudModerationRequest, CreateCloudRecordingRequest, DeleteCloudRecordingResponse, StartAITranscriptionRequest, StopMCUMixTranscodeByStrRoomIdRequest, StartAIConversationRequest, DeletePictureResponse, ModifyCloudRecordingRequest, StopAIConversationResponse, CreateLiveStreamModerationResponse, DescribeAIConversationRequest, DismissRoomByStrRoomIdRequest, DescribeCloudTranscriptionRequest, CreateCloudSliceTaskResponse, StartMCUMixTranscodeResponse, DescribeTrtcMcuTranscodeTimeResponse, DeleteCloudRecordingRequest, DescribePictureRequest, DownloadRecognizeVocabV3Request, ModifyCloudModerationResponse, DescribeLiveStreamModerationRequest, DescribeTRTCSegmentModerationUsageResponse, DescribePictureResponse, DescribeTrtcRoomUsageRequest, TextToSpeechResponse, CreateCloudModerationRequest, StopStreamIngestRequest, DescribeTrtcMcuTranscodeTimeRequest, StopStreamIngestResponse, DescribeScaleInfoRequest, ControlAIConversationRequest, DismissRoomByStrRoomIdResponse, StopPublishCdnStreamResponse, StopPublishCdnStreamRequest, DescribeUnusualEventResponse, ModifyCloudRecordingResponse, CreateCloudTranscriptionRequest, AsyncTextToSpeechResponse, GetRecognizeVocabListV3Request, DescribeCloudSliceTaskRequest, StartMCUMixTranscodeByStrRoomIdRequest, SetVocabStateV3Request, DescribeTRTCMarketQualityDataRequest, DescribeTRTCRealTimeScaleDataResponse, DeleteCloudTranscriptionRequest, UpdatePublishCdnStreamRequest, DescribeTRTCDedicatedCloudAccUsageRequest, VoiceCloneResponse, UpdateStreamIngestRequest, TextToSpeechSSERequest, StopWebRecordResponse, DeletePictureRequest, StopWebRecordRequest, UpdateVoicePrintRequest, StartPublishCdnStreamRequest, UpdateAIConversationRequest, UpdatePublishCdnStreamResponse, RemoveUserByStrRoomIdRequest, UpdateRecognizeVocabV3Response, UpdateRecognizeVocabV3Request, TextToSpeechRequest, DescribeStreamIngestRequest, UpdateVoicePrintResponse, DownloadRecognizeVocabV3Response, DescribeTRTCDedicatedCloudAccUsageResponse, DescribeTRTCAIRecognitionUsageRequest, StopAITranscriptionResponse, CreateRecognizeVocabV3Response, StopMCUMixTranscodeRequest, DescribeCloudModerationRequest, DescribeAITranscriptionResponse, DescribeCloudSliceTaskResponse, CreatePictureResponse, StartAITranscriptionResponse, RemoveUserResponse } from "./trtc_models";
/**
 * trtc client
 * @class
 */
...
使用输入在线媒体流功能需先订阅 [尊享版或旗舰版套餐包](https://cloud.tencent.com/document/product/647/85386) 解锁能力位。
     ...
     * 短音频同步内容理解接口
     */
    CreateAudioModerationSync(req: CreateAudioModerationSyncRequest, cb?: (error: string, rep: CreateAudioModerationSyncResponse) => void): Promise<CreateAudioModerationSyncResponse>;
    /**
...
• 注意: 热词权重设置为11时，当前热词将升级为超级热词，建议仅将重要且必须生效的热词设置到11，设置过多权重为11的热词将影响整体字准率。
     */
    CreateRecognizeVocabV3(req: CreateRecognizeVocabV3Request, cb?: (error: string, rep: CreateRecognizeVocabV3Response) => void): Promise<CreateRecognizeVocabV3Response>;
    /**
