 ...
 * Agent 创建云函数镜像配置
 */
export interface AgentRuntimeCodeImageConfig {
    /**
...
export interface GetFunctionResponse {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    ImageConfig?: AgentRuntimeCodeImageConfig;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface DownloadFunctionRequest {
    /**
     * <p>函数的名称</p>
     */
    FunctionName: string;
 ...
 */
export interface DownloadFunctionResponse {
    /**
     * <p>调用SCF报错的错误码</p>
     */
    SCFErrorCode?: string;
 ...
 * 云函数公网访问配置
 */
export interface FunctionPublicNetConfig {
    /**
