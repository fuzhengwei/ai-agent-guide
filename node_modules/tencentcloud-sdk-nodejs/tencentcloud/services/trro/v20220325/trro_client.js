...
转推回调事件内容参考：https://cloud.tencent.com/document/product/647/88552
     ...
     * 删除整个任务并级联删除其全部处理项。
     */
    async DeleteAnnotationJob(req, cb) {
     ...
     */
    async DescribeAnnotationJobs(req, cb) {
     ...
     */
    async CreateVideoAnnotationJob(req, cb) {
...
开启项目共享密钥后，对于已注册的设备，仍可使用原设备密码登录。若希望仅能通过共享密钥生成密码登录，请通过云 API 将设备密码更新为"USEPROJECTKEYPWD"。
     ...
     */
    async CreateBatchVideoAnnotationJob(req, cb) {
        return this.request("CreateBatchVideoAnnotationJob", req, cb);
    }
    /**
     * 删除任务下的单个处理项。
     */
    async DeleteAnnotationTask(req, cb) {
     ...
     */
    async DescribeAnnotationTasks(req, cb) {
