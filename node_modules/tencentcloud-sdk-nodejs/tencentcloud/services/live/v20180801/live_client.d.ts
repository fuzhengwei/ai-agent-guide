...
点播文件与直播地址将停止展示，客户自行推到导播台的流需要手动停止。
     ...
     */
    DeleteLiveAvatarCloneFigure(req: DeleteLiveAvatarCloneFigureRequest, cb?: (error: string, rep: DeleteLiveAvatarCloneFigureResponse) => void): Promise<DeleteLiveAvatarCloneFigureResponse>;
    /**
...
注意，修改的Index对应的水印需已存在
     ...
     * 获取关键词库列表，直播审核功能使用。
     */
    DescribeAuditKeywordLibs(req: DescribeAuditKeywordLibsRequest, cb?: (error: string, rep: DescribeAuditKeywordLibsResponse) => void): Promise<DescribeAuditKeywordLibsResponse>;
    /**
     * 该接口用来查询某个特定监播任务的配置。
     */
...
查询天维度每条流的播放数据，包括总流量等。
     ...
     * 更新关键词库信息，直播审核功能使用。
     */
    ModifyAuditKeywordLib(req: ModifyAuditKeywordLibRequest, cb?: (error: string, rep: ModifyAuditKeywordLibResponse) => void): Promise<ModifyAuditKeywordLibResponse>;
    /**
     * 删除转码规则。
...
注意，调用该接口后，所有的导播台信息将被清除，包括正在直播的内容也将直接中断。
     ...
     * 直播审核图库删除图片。
     */
    DeleteAuditImages(req: DeleteAuditImagesRequest, cb?: (error: string, rep: DeleteAuditImagesResponse) => void): Promise<DeleteAuditImagesResponse>;
    /**
     * 批量获取日志URL。
...
查询播放数据，支持按流名称查询详细播放数据，也可按播放域名查询详细总数据，数据延迟4分钟左右。
     ...
     * 调用该接口，用于创建数字人直播间/AIGC直播间话术。
     */
    CreateLiveAvatarCloneFigure(req: CreateLiveAvatarCloneFigureRequest, cb?: (error: string, rep: CreateLiveAvatarCloneFigureResponse) => void): Promise<CreateLiveAvatarCloneFigureResponse>;
    /**
     * 获取回调规则列表
     */
     ...
     * 获取标签组分类数据，直播审核中。
     */
    DescribeAuditGroupTag(req: DescribeAuditGroupTagRequest, cb?: (error: string, rep: DescribeAuditGroupTagResponse) => void): Promise<DescribeAuditGroupTagResponse>;
    /**
...
3. 如果配置了域名分组，需填写准确推流域名，才可断掉当前推流。
     ...
     */
    CreateAuditImages(req: CreateAuditImagesRequest, cb?: (error: string, rep: CreateAuditImagesResponse) => void): Promise<CreateAuditImagesResponse>;
    /**
     * 调用该接口，用于创建数字人直播间。
     */
...
<br>录制相关文档：[直播录制](/document/product/267/32739)。
     ...
     * 删除关键词库，直播审核功能使用。
     */
    DeleteAuditKeywordLib(req: DeleteAuditKeywordLibRequest, cb?: (error: string, rep: DeleteAuditKeywordLibResponse) => void): Promise<DeleteAuditKeywordLibResponse>;
    /**
     * 直播播放带宽和流量数据查询。
     */
...
<br>转码相关文档：[直播转封装及转码](/document/product/267/32736)。
     ...
     * 直播审核图库获取图片。
     */
    DescribeAuditImages(req: DescribeAuditImagesRequest, cb?: (error: string, rep: DescribeAuditImagesResponse) => void): Promise<DescribeAuditImagesResponse>;
    /**
     * 将正在运行的拉流转推任务进行重启。
注意：
1. 重启任务会造成推流中断。
...
<br>转码相关文档：[直播转封装及转码](/document/product/267/32736)。
     ...
     * 调用该接口，查询数字人直播间信息列表。
     */
    DescribeLiveAvatarCloneFigureList(req: DescribeLiveAvatarCloneFigureListRequest, cb?: (error: string, rep: DescribeLiveAvatarCloneFigureListResponse) => void): Promise<DescribeLiveAvatarCloneFigureListResponse>;
    /**
     * 获取转码规则列表
     */
