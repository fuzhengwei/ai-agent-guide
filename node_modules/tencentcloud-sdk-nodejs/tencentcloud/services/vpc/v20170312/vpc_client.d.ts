...
* 创建路由表同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     */
    ModifyNatGatewayAdvancedAttribute(req: ModifyNatGatewayAdvancedAttributeRequest, cb?: (error: string, rep: ModifyNatGatewayAdvancedAttributeResponse) => void): Promise<ModifyNatGatewayAdvancedAttributeResponse>;
    /**
