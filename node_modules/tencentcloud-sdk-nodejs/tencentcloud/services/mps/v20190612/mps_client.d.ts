...
注意：模板 ID 10000 以下的为系统预置模板，不允许修改。
     ...
     */
    ChangeVoice(req: ChangeVoiceRequest, cb?: (error: string, rep: ChangeVoiceResponse) => void): Promise<ChangeVoiceResponse>;
    /**
     * 获取热词库列表
     */
...
* 只能查询到最近七天（168小时）内的任务。
     ...
     * 调用该接口，用于创建Agent录制任务。
     */
    CreateAgentRecordTask(req: CreateAgentRecordTaskRequest, cb?: (error: string, rep: CreateAgentRecordTaskResponse) => void): Promise<CreateAgentRecordTaskResponse>;
    /**
     * 图片处理任务查询接口。
     */
...
注意：模板 ID 为 10000 以下的为系统预置模板，不允许删除。
     ...
     * 提交创建混元3D的任务
     */
    SubmitHunyuan3DTask(req: SubmitHunyuan3DTaskRequest, cb?: (error: string, rep: SubmitHunyuan3DTaskResponse) => void): Promise<SubmitHunyuan3DTaskResponse>;
    /**
     * 修改 AIGC 文档生视频任务状态。

包含 confirm（确认当前阶段）和 regenerate（重新生成当前阶段）两种动作含义。
     */
    ModifyDocToVideoTaskStatus(req: ModifyDocToVideoTaskStatusRequest, cb?: (error: string, rep: ModifyDocToVideoTaskStatusResponse) => void): Promise<ModifyDocToVideoTaskStatusResponse>;
    /**
...
5. 美颜滤镜；
     ...
     */
    DescribeAgentRecordTask(req: DescribeAgentRecordTaskRequest, cb?: (error: string, rep: DescribeAgentRecordTaskResponse) => void): Promise<DescribeAgentRecordTaskResponse>;
    /**
...
直播流处理事件通知支持HTTP回调，也支持实时写入用户指定的消息队列 CMQ 中，用户从消息队列 CMQ 中获取事件通知结果，同时处理过程中存在输出文件的，会写入用户指定的输出文件的目标存储中。
     ...
     * 查询混元3D任务对应的结果
     */
    QueryHunyuan3DTask(req: QueryHunyuan3DTaskRequest, cb?: (error: string, rep: QueryHunyuan3DTaskResponse) => void): Promise<QueryHunyuan3DTaskResponse>;
    /**
     * 查询媒体传输流的媒体质量数据。
     */
