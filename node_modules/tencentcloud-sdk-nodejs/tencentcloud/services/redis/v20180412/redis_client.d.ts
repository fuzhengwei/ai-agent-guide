...
- 可查询近30天内任务列表数据。
     ...
     */
    ModifyInstancePasswordPolicy(req: ModifyInstancePasswordPolicyRequest, cb?: (error: string, rep: ModifyInstancePasswordPolicyResponse) => void): Promise<ModifyInstancePasswordPolicyResponse>;
    /**
     ...
     * 查询指定实例当前密码复杂度配置
     */
    DescribeInstancePasswordPolicy(req: DescribeInstancePasswordPolicyRequest, cb?: (error: string, rep: DescribeInstancePasswordPolicyResponse) => void): Promise<DescribeInstancePasswordPolicyResponse>;
    /**
