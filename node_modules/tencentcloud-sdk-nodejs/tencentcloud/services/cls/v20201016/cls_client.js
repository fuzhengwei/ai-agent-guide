...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 删除产品接入任务
     */
    async DeleteResourceGraphProductIngestTask(req, cb) {
...
API 中 Region 填写任意一个地域均可，建议使用广州(ap-guangzhou)
     ...
     */
    async DescribeResourceGraphEntities(req, cb) {
...
如果该时刻向前推5分钟内均无指标数据，则无相应的查询结果。
     ...
     */
    async DeleteResourceGraph(req, cb) {
...
API 中 Region 填写任意一个地域均可开通所有地域的 CLS，建议使用广州(ap-guangzhou)
     ...
     * 查询资源图谱失败详情
     */
    async DescribeResourceGraphIngestTaskFailureDetail(req, cb) {
     ...
     */
    async DescribeResourceGraphProductIngestTaskList(req, cb) {
     ...
     */
    async ModifyResourceGraphProductIngestTask(req, cb) {
     ...
     * 创建工作区。
     */
    async CreateResourceGraph(req, cb) {
     ...
     * 修改CLS投递任务
     */
    async ModifyCLSDeliverTask(req, cb) {
     ...
     */
    async DescribeResourceGraphEntityDetail(req, cb) {
     ...
     * 查询单个云产品接入的详情，包含基本信息、实例选择、eBPF 采集规则和关联的日志主题。
     */
    async DescribeResourceGraphProductIngestTaskDetail(req, cb) {
     ...
     */
    async DescribeResourceGraphs(req, cb) {
     ...
     */
    async ModifyResourceGraph(req, cb) {
     ...
     */
    async CreateResourceGraphProductIngestTask(req, cb) {
     ...
     * 查询资源图谱失败详情
     */
    async DescribeResourceGraphFailureDetail(req, cb) {
     ...
     * 修改资源图谱实体与日志主题关系
     */
    async ModifyResourceGraphEntityTopicsRelation(req, cb) {
...
- NoticeRules
     ...
     * 删除CLS投递任务
     */
    async DeleteCLSDeliverTask(req, cb) {
...
2. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 资源图谱tke集群接入状态
     */
    async DescribeResourceGraphTkeClusterStatus(req, cb) {
...
注意：修改接口直接覆盖历史数据，改为本次合法入参数据，请谨慎调用此接口。
     ...
     * 重试初始化资源图谱工作区
     */
    async RetryResourceGraphProductIngestTask(req, cb) {
...
将生成的 cls.pb.h 头文件引入代码中，调用接口进行数据格式封装。
     ...
     */
    async DescribeResourceGraphEntityDependency(req, cb) {
...
2. 本接口存在频率限制，不适合批量读取海量日志，如需下载或实时读取日志，建议使用[日志下载](https://cloud.tencent.com/document/product/614/52901)或[投递与消费](https://cloud.tencent.com/document/product/614/37908)功能。
     ...
     * 获取CLS投递任务列表
     */
    async DescribeCLSDeliverTasks(req, cb) {
     ...
     * 新建CLS投递任务
     */
    async CreateCLSDeliverTask(req, cb) {
